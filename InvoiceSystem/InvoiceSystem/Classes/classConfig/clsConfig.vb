...
Public Class clsConfig
    ...
    Public Function IsValidDateTime(ByVal IsDateTime As Object) As DateTime
        If IsDBNull(IsDateTime) Then
            Return Today.Date()
        Else
            Return IsDateTime
        End If
    ...
    Public Function UserAccess(ByVal UserId As String, ByVal MenuId As String, Optional ByVal AccessType As String = "MENU") As Boolean
        ...
        End If
    End Function
    Public Function UserRole(ByVal pEmpCd As String, ByVal pRoleID As String) As Boolean
        'Sitthana 06/10/2018
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        ...
        comm.Parameters.AddWithValue("@p_RoleID", pRoleID)
