...
Public Class classRequest
    ...
    Public Function GetSORollNoGrid(Optional ByVal strDFNo As String = "", Optional ByVal strSoNoID As String = "", Optional ByVal strDesignNo As String = "", Optional ByVal strGwth As String = "", Optional ByVal strCol As String = "", Optional ByVal strGr As String = "") As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_req_det_dc_d_onhand3"
    ...
    Public Function GetSORollNoGrid3(Optional ByVal strDFNo As String = "", Optional ByVal strSoNoID As String = "", Optional ByVal strDesignNo As String = "", Optional ByVal strGwth As String = "", Optional ByVal strCol As String = "", Optional ByVal strGr As String = "") As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_req_det_dc_g_onhand3"
        comm.Parameters.AddWithValue("@outreqno", strDFNo.Trim)
        comm.Parameters.AddWithValue("@sonoid", strSoNoID.Trim)
        comm.Parameters.AddWithValue("@design_no", strDesignNo.Trim)
        comm.Parameters.AddWithValue("@gwth", strGwth.Trim)
    ...
    Public Function GetReqNo(Optional ByVal strStockType As String = "A", Optional ByVal strReqNo As String = "", Optional ByVal strDateFr As String = "", Optional ByVal strDateTo As String = "", Optional ByVal strCustCD As String = "") As DataTable
        ...
        Return dt
    End Function
    Public Function GetPackno(Optional ByVal strPackno As String = "", Optional ByVal strDateFr As String = "", Optional ByVal strDateTo As String = "", Optional ByVal strCustCD As String = "") As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
    ...
    Public Function ReqDetGLoad(ByVal strReqNo As String) As DataTable
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_req_det_g_select3"
        comm.Parameters.AddWithValue("@outreqno", strReqNo)
        Dim da As New SqlDataAdapter(comm)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Public Function ValidateReqNoIsCancel(ByVal outreqno As String, ByVal logempcd As String) As DataTable
        ...
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_req_validate_item"
        ...
        Return dt
    End Function
    Public Function ValidateReqNoOut(ByVal outreqno As String, ByVal logempcd As String) As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)

        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_req_validate_out"
        comm.Parameters.AddWithValue("@outreqno", outreqno)
        comm.Parameters.AddWithValue("@logempcd", logempcd)
        Dim da As New SqlDataAdapter(comm)
        Dim dt As New DataTable
