...
Public Class classStockDINPurchase
    ...
    'Conversion Project
    Public Function DinPurchaseSave(ByVal Din_header As classStockDINPurchase.Strolls_DHeader, ByRef msgerr As String, ByVal dfc As DataTable, ByVal DV_DTC_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByRef UserID As String, ByRef DINno As String) As Boolean
        ...
        For j = 0 To DV_DTC_ADD.Count - 1
            With DV_DTC_ADD
                ...
                comm.Parameters.AddWithValue("@suppcd", config.IsNull(.Item(j)("suppcd"), DBNull.Value))
