Public Class frmCRNoteControl
    ...
    Private Sub frmCRNoteControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        
    End Sub

    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Const rptFileName = "rptCRNoteControl.rpt"
        ...
        rpt.VerifyDatabase()
        rpt.SetParameterValue("@invno", txtInvNo.Text)
