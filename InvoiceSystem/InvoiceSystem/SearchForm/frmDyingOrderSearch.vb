Public Class frmDyingOrderSearch
    ...
    Private Sub GenGrid()
        ...
        dt = objDB.DFLoad(txtDFNo.Text.Trim.ToUpper, dtpDateFr.Value.ToString("yyyyMMdd"), dtpDateTo.Value.ToString("yyyyMMdd"), config.IsNull(cboSoNo.SelectedValue, "").ToString.Trim, config.IsNull(cboCustomer.SelectedValue, "").ToString.Trim, config.IsNull(cboDyedHouse.SelectedValue, "").ToString.Trim, config.IsNull(cboDesignNo.SelectedValue, "").ToString.Trim, config.IsNull(cboEmpCD.SelectedValue, "").ToString.Trim)
