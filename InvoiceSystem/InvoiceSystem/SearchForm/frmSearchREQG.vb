Public Class frmSearchREQG
    ...
    Private Sub GenGrid()
        ...
        dt = objDB.SearchOutReqNo(strStockType, txtReqNo.Text.Trim.ToUpper, dtpDateFr.Value.ToString("yyyyMMdd"), dtpDateTo.Value.ToString("yyyyMMdd"), clsConfig.IsNull(cboCustomer.SelectedValue, "").ToString.Trim.ToUpper)
