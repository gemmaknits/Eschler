Public Class frmGINDocument
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        rpt.VerifyDatabase()
        rpt.SetParameterValue("@trannofr", cboFromGINNO.SelectedValue)
        rpt.SetParameterValue("@trannoto", cboToGINNO.SelectedText)
    ...
    Private Sub GenCombo()
        ...
        cboFromGINNO.DataSource = Objdb
        cboFromGINNO.DisplayMember = "docno"
        cboFromGINNO.ValueMember = "docno"

        cboToGINNO.DataSource = Objdb2
        cboToGINNO.DisplayMember = "docno"
        cboFromGINNO.ValueMember = "docno"
