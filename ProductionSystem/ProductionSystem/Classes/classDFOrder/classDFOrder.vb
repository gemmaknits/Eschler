...
Public Class classDFOrder
	...
	Public Function DFCancel(ByVal strDFNo As String, ByVal strEmpCD As String) As Boolean
		Dim conn As New SqlConnection((New classConnection).connection)
		conn.Open()
		Dim tran As SqlTransaction = conn.BeginTransaction
		Dim comm As New SqlCommand("", conn)
    ...
    Public Function DforderApproveUpdate(ByVal dt As DataTable, ByRef msgerr As String, ByRef success As Boolean, ByVal strEmpCD As String) As DataTable
        ...
        For i = 0 To dt.Rows.Count - 1
            ...
            comm.Parameters.AddWithValue("@bulkok", config.IsNull(dt.Rows(i)("bulkok"), 0))
            comm.Parameters.AddWithValue("@bulknotok", config.IsNull(dt.Rows(i)("bulknotok"), 0))
