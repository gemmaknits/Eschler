...
Public Class classStockGIN_KOManual
    ...
    End Function
    'Conversion Project
    Public Function GetGINKOManualSearchKO(Optional ByVal strkono As String = "", Optional ByVal strDateFr As String = "", Optional ByVal strDateTo As String = "", Optional ByVal strsuppcd As String = "", Optional ByVal StrDesignNo As String = "") As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
    ...
    Public Function GetGINKOBYKO(Optional ByVal strKONO As String = "", Optional ByVal strEmpCD As String = "") As DataTable
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_select_ko"
    ...
    End Function
    Public Function GetComboDefectCode(Optional ByVal StrDefect_code As String = "", Optional ByVal StrEmpCd As String = "") As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
    ...
    Public Function GIN_KOManualsave(ByVal Gin_header As Greige_Header, ByVal Defect_Roll_Header As Defect_roll_Header, ByRef msgerr As String, ByVal dfc As DataTable, ByVal DV_DTC_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByRef UserID As String, ByRef Tran_no As String, ByRef Roll_no As String) As Boolean
        ...
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_delete_defect_roll"
    ...
    Public Function GIN_KOManualScarp(ByVal Gin_header As Greige_Header, ByVal Defect_Roll_Header As Defect_roll_Header, ByRef msgerr As String, ByVal dfc As DataTable, ByVal DV_DTC_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByRef UserID As String, ByRef Tran_no As String, ByRef Roll_no As String) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        comm.CommandText = "p_greige_in_ko_manual_update_scarp" 'Use 1 Stroreprocedure insert & update
    ...
    Public Function GIN_KOManualCancel(ByVal Gin_header As Greige_Header, ByRef Msgerr As String, ByVal dtc As DataTable, ByVal UserID As String, ByVal tran_no As String) As Boolean
        ...
        'Start  Add PLD bin-----------
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_insert_bin"
        With Gin_header
            comm.Parameters.Clear()
            comm.Parameters.AddWithValue("@suppcd", Gin_header.h01_suppcd)
            comm.Parameters.AddWithValue("@source", Gin_header.h02_source)
        ...
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_delete_greige"
        With Gin_header
            comm.Parameters.Clear()
            comm.Parameters.AddWithValue("@suppcd", Gin_header.h01_suppcd)
            comm.Parameters.AddWithValue("@source", Gin_header.h02_source)
    ...
    Public Function getDefaultSubInventoryId(pMtlWareHouseId As Nullable(Of Int64)) As Nullable(Of Int64)
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_get_default_subinventory_id"
        comm.Parameters.Clear()
    ...
    End Function
    Public Function getDefaultLocationId(pMtlSubInventoryId As Nullable(Of Int64)) As Nullable(Of Int64)
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_GREIGE_IN_KO_MANUAL_PKG_get_default_location_id"
        comm.Parameters.Clear()
        ...
        If dt.Rows.Count > 0 Then
            pMtlLocationsId = dt.Rows(0)("mtl_locations_id")
        End If
        Return pMtlLocationsId
    End Function
End Class
