...
Public Class frmLogin
    ...
    Private Function checkCanLoginAndKeepGlbValue()
        ...
        Else
            ...
            clsUser.ExchangeRateTHB = (New clsConfig).IsNull(ds.Tables("tableEmp").Rows(0)("exchange_rate_thb"), 0)
            ...
            If oConfig.IsNull(clsUser.ExchangeRateUSD, 0) = 0 Then
                clsUser.ExchangeRate = clsMaster.GetExchangeRateAPI("USD")
                clsUser.ExchangeRateUSD = clsMaster.GetExchangeRateAPI("USD")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateJPY, 0) = 0 Then
                clsUser.ExchangeRateJPY = clsMaster.GetExchangeRateAPI("JPY")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateAUD, 0) = 0 Then
                clsUser.ExchangeRateAUD = clsMaster.GetExchangeRateAPI("AUD")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateCHF, 0) = 0 Then
                clsUser.ExchangeRateCHF = clsMaster.GetExchangeRateAPI("CHF")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateEUR, 0) = 0 Then
                clsUser.ExchangeRateEUR = clsMaster.GetExchangeRateAPI("EUR")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateHKD, 0) = 0 Then
                clsUser.ExchangeRateHKD = clsMaster.GetExchangeRateAPI("HKD")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateRMB, 0) = 0 Then
                clsUser.ExchangeRateRMB = clsMaster.GetExchangeRateAPI("CNY")
            ...
            If oConfig.IsNull(clsUser.ExchangeRateCNY, 0) = 0 Then
                clsUser.ExchangeRateCNY = clsMaster.GetExchangeRateAPI("CNY")
