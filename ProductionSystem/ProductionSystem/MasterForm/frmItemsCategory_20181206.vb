...
Public Class frmItemsCategory
    ...
    Private Function SaveData() As Boolean
        ...
        'If result = Windows.Forms.DialogResult.Cancel Then Exit Function
    ...
    Private Sub grdItemsProperties_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdItemsProperties.CellContentClick
    ...
    Private Sub cboproperty_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cboproperty.SelectedIndexChanged
    ...
    Private Sub grdItemsProperties_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles grdItemsProperties.KeyDown
    ...
    Private Sub grdSPLFunction_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdSPLFunction.CellContentClick

    End Sub

    Private Sub grdApplication_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdApplication.CellContentClick
    ...
    Private Sub btnPrintReportViewer_Click(sender As System.Object, e As System.EventArgs) Handles btnPrintReportViewer.Click
    ...
    Private Sub BtnPrint2_Click(sender As System.Object, e As System.EventArgs) Handles BtnPrint.Click
        Dim clsconfig As New clsConfig
        Const rptFileName = "rptInventoryCategory3.rpt" 'Only For 1 Design
    ...
    Private Sub chkitem_disabled_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkitem_disabled.CheckedChanged
    ...
    Private Sub grdItemsCategory_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdItemsCategory.CellContentClick

    End Sub

    Private Sub grdItemsCategory_Leave(sender As Object, e As EventArgs) Handles grdItemsCategory.Leave
        ' MsgBox("grdItemsCategory_Leave")
    End Sub

    Private Sub cboItemSubgroup2_Disposed(sender As Object, e As EventArgs) Handles cboItemSubgroup2.Disposed
        'MsgBox("cboItemSubgroup2_Disposed")
    End Sub

    Private Sub grdItemsCategory_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles grdItemsCategory.CellMouseClick

    End Sub

    Private Sub grdItemsCategory_CellLeave(sender As Object, e As DataGridViewCellEventArgs) Handles grdItemsCategory.CellLeave
        'grdItemsCategory.Item(e.ColumnIndex, e.RowIndex).Value = DBNull.Value

        'MsgBox("grdItemsCategory_CellLeave  : " & grdItemsCategory.Item(e.ColumnIndex, e.RowIndex).Value)
    End Sub
