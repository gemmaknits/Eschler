Public Class frmKOPending
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        Const rptFileName = "rptKOPendingByMC.rpt"
        ...
        rpt.VerifyDatabase()
        rpt.SetParameterValue("@Date_type", 1)
        rpt.SetParameterValue("@month", "")
        rpt.SetParameterValue("@logempcd", "")

        frm.Title = "P/O Pending By Mc"
