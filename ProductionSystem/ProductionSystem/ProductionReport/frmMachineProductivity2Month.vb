Public Class frmMachineProductivity2Month
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        ...
        rptFileName = IIf(optDate.Checked, "rptMachineProductivity2Month.rpt", IIf(optShift.Checked, "rptMachineProductivityByShift.rpt", IIf(optSummary.Checked, "rptMachineProductivitySum.rpt", "rptMachineProductivityByMonth.rpt")))
        ...
        'rpt.DataSourceConnections.Item(0).LogonProperties.Set("General Timeout", "10") 'Use For ?

        rpt.VerifyDatabase()

        rpt.SetParameterValue("@monthfrom", dtpStartDate.Value.ToString("yyyyMM"))
        rpt.SetParameterValue("@monthto", dtpEndDate.Value.ToString("yyyyMM"))
