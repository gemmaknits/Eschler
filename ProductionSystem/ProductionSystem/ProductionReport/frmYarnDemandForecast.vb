Public Class frmYarnDemandForecast
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Dim rptFileName = "rptYarnDemandForecast.rpt"
        ...
        If rbtByRealTine.Checked Then rptFileName = "rptYarnDemandForecast.rpt"
        If rbtByLogDate.Checked Then rptFileName = "rptYarnDemandForecastLog.rpt"
        ...
        If rbtByLogDate.Checked Then rpt.SetParameterValue("@rep_date", dtpRepDate.Value.ToString("yyyyMMdd"))
