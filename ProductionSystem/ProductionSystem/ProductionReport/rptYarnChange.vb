...
Public Class rptYarnChange
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProductionSystem.rptYarnChange.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_yarnchange() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ynchgcd() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptYarnChange
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptYarnChange = New rptYarnChange()
        rpt.Site = Me.Site
        Return rpt
    End Function
