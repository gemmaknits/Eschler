Public Class frmOperationKnitting
    ...
    Private Sub Loaddata(Optional ByVal strsystem_lot_number As String = Nothing)
        ...
        dtProductionLots = (New classOperationKnitting).GetMfgOperationStepKnitting(IntMfgProductionLotsID:=Nothing,
    ...
    Public Function Save() As Boolean
        ...
        Dim classOperationKnitting As New classOperationKnitting
        Dim Defect_Roll_Header As New classOperationKnitting.Defect_roll_Header
        ...
        If classOperationKnitting.SavaData(mfg_production_lots:=mfg_production_lots, Defect_Roll_Header:=Defect_Roll_Header _
    ...
    Private Function SaveGINKOManual(Optional ByVal strGINNO As String = "") As Boolean
        ...
        Dim objDB As New classOperationKnitting
        Dim Greige_Header As New classOperationKnitting.Greige_Header
        Dim Defect_Roll_Header As New classOperationKnitting.Defect_roll_Header
