Public Class frmProductionRoutingKnitting
    ...
    Private Sub frmProductionRouting_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        LoadDataRouting(Intmfg_production_steps_id:=Nothing, Strproduction_order_no:=KO.kono)
        LoadDataLots(Intmfg_production_steps_id:=mfg_production_lots.mfg_production_steps_id, Strproduction_order_no:=KO.kono)
    ...
    Private Sub InitControl()
        ...
        GenCBOcbomcno(cbomcno)
        GenCboStepStatus(cbostep_status)
        GenCbooperations(operation_id)
        'GenCBOINGRID()
        LoadDataRouting(0, 0)
        LoadDataLots(0, 0)
        'Loaddata(Nothing, KO.kono)
        'CleargrdData(0, 0, 0)
    ...
    Public Function GenDataLots() As Boolean
        Dim classProductionLots As New classProductionRoutingKnitting
        ...
        'If 
        'Try
        'dt = classProductionLots.GenData(mfg_production_lots, grdDataLots.DataSource, dv_add, dv_upd, dv_del, clsuser)
        ...
        dt = classProductionLots.GenDataLots(mfg_production_lots:=mfg_production_lots, set_per_lot:=0 _
                                             , grdDataLots:=grdDataLots.DataSource, dv_add:=dv_add _
                                             , dv_upd:=dv_upd, dv_del:=dv_del, clsuser:=clsuser) 'Then
    ...
    Public Function SaveDataLots() As Boolean
        Dim objdb As New classProductionRoutingKnitting
        ...
        If objdb.SavaDataLots(mfg_production_lots:=mfg_production_lots, Defect_Roll_Header:=Defect_Roll_Header _
    ...
    Private Sub PrintSystemLotNumber()
        Dim clsConfig As New clsConfig
        Dim rptFileName = "rptSystemLotNumber.rpt"  'rptSystemLotNumber2Lbl.rpt
        'If clsuser.ReportPath = "" Then clsuser.ReportPath = clsConfig.ReportPath
        'clsUser.ReportPath = "C:\Users\DELL\Desktop\GemmaKnits\"
    ...
    Private Sub PrintSystemLotNumberMultipleColumns()
        Dim clsConfig As New clsConfig
        Dim rptFileName = "rptSystemLotNumberMultipleColumns.rpt"  'rptSystemLotNumber2Lbl.rpt
        'If clsuser.ReportPath = "" Then clsuser.ReportPath = clsConfig.ReportPath
        'clsUser.ReportPath = "C:\Users\DELL\Desktop\GemmaKnits\"
        If Not clsConfig.CheckReport(clsuser.ReportPath, rptFileName) Then Exit Sub
        Dim frm As New frmReport
    ...
    Private Sub PrintListMultipleColumns()
        Dim clsConfig As New clsConfig
        Dim rptFileName = "rptSystemLotNumberMultipleColumns.rpt"
        'If clsuser.ReportPath = "" Then clsuser.ReportPath = clsConfig.ReportPath
        'clsUser.ReportPath = "C:\Users\DELL\Desktop\GemmaKnits\"
        If Not clsConfig.CheckReport(clsuser.ReportPath, rptFileName) Then Exit Sub
        Dim frm As New frmReport
    ...
    Private Sub PrintList()
        Dim clsConfig As New clsConfig
        Dim rptFileName = "rptSystemLotNumber.rpt"
        'If clsuser.ReportPath = "" Then clsuser.ReportPath = clsConfig.ReportPath
        'clsUser.ReportPath = "C:\Users\DELL\Desktop\GemmaKnits\"
        If Not clsConfig.CheckReport(clsuser.ReportPath, rptFileName) Then Exit Sub
        Dim frm As New frmReport
    ...
    Private Sub btnPrintStickerMultipleColumns_Click(sender As Object, e As EventArgs) Handles btnPrintStickerMultipleColumns.Click
        Call PrintSystemLotNumberMultipleColumns()
    End Sub

    Private Sub BtnPrintListMultipleColumns_Click(sender As Object, e As EventArgs) Handles BtnPrintListMultipleColumns.Click
        Call PrintListMultipleColumns()
    End Sub
End Class