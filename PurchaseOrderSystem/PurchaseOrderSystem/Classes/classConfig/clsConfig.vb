...
Public Class clsConfig
    ...
    Public Const ImagePath = "\\SRV-GEMMAKNITS\MEDIA\PHOTO\DESIGN\" 'Add By Sitthana 10/11/2018
    ...
    Public Function ConvertFormatDateTostring(ByVal FieldDate As Object) As String
        If FieldDate.ToString.Length = 0 Then Return "01/01/1900"
        Dim Day As String
        Dim Month As String
        Dim Year As String
    ...
    Public Function IsNull(ByVal obj1 As Object, ByVal obj2 As Object) As Object
        ...
        End If
    End Function
    Public Function NullIF(ByVal obj1 As Object, ByVal obj2 As Object) As Object
        NullIF = obj1
        If IsDBNull(obj1) Or TypeOf obj1 Is VariantType Or IsNothing(obj1) Or obj1 Is Nothing Then
            NullIF = Nothing
        Else
            Select Case VarType(obj1)
                Case VariantType.String
                    If RTrim(obj1) = "" Then NullIF = obj2
                Case VariantType.Long
                    If Val(obj1) = 0 Then NullIF = obj2
                Case VariantType.Double
                    If Val(obj1) = 0 Then NullIF = obj2
                Case VariantType.Integer
                    If Val(obj1) = 0 Then NullIF = obj2
                Case VariantType.Decimal
                    If Val(obj1) = 0 Then NullIF = obj2
                Case VariantType.Date
                    If obj1 = CDate("01/01/1900") Then NullIF = obj2
                Case Else
                    NullIF = obj1
            End Select
        End If
