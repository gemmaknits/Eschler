Public Class classConnection
    ...
    Public Shared database As String = "gemmasoft" 'EschlerDB
    ...
    Public Function ComboDatabase(Optional ByVal strUSerID As String = "") As DataTable
        ...
        dt.Rows.Add("ESH", "172.16.3.10", "gemmasoft") 'EschlerDB
        dt.Rows.Add("TEST", "172.16.3.10", "gemmasoftTest") 'EschlerDBTest
