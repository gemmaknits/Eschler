...
Imports System.Text
Public Class formPurchaseOrderCancel
    ...
    Private Sub BtnYarnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnYarnSave.Click
        If Not (clsUser.DeptCD = "PURCHASING" Or clsUser.DeptCD = "ITC" Or clsUser.DeptCD = "ACC" Or clsUser.DeptCD = "ACCOUNTS") Then
        ...
        If MsgBox("Are you sure to cancel", MsgBoxStyle.YesNo, "Cancel P/O") = MsgBoxResult.Yes Then
            isvalid = objPurchase.cancelPurchaseOrder(Me.txtPurno.Text, Me.textCancelRemark.Text, msgerr, Me.loginEmpcd)

            If isvalid = True Then
                '			MsgBox("P/O updated successfully", MsgBoxStyle.Information)
                errorSaved.SetError(Me.txtPurno, "P/O cancelled")
            Else
                MsgBox(msgerr)
            End If
        End If
