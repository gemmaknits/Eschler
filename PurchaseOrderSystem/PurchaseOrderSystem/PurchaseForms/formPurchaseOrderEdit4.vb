...
Imports System.Text
Public Class formPurchaseOrderEdit4
    ...
    Private Sub showPOData()
        ...
        Try
            ...
            strsql2 = "exec p_po_select '" & Me.txtPurno.Text.Trim & "'"
            ...
            strsql2 = "exec p_po_det_select '" & Me.txtPurno.Text.Trim & "'"
    ...
    Private Sub formPurchaseOrderEdit4_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub GetDataComcoInDgridItems()
        ...
        Me.Itemcd.DataSource = dt
        Me.Itemcd.DisplayMember = "itcd"
        Me.Itemcd.ValueMember = "itcd"
    End Sub
    ...
    Private Sub formPurchaseOrderEdit4_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BtnYarnSave_Click(sender As System.Object, e As System.EventArgs) Handles BtnYarnSave.Click
        ...
        For i = 0 To Me.DgYarn.Rows.Count - 2
            ...
            Obj_tbl_job.tbl_job_det(i).supquoteno = Clsconfig.IsNull(Me.DgYarn.Rows(i).Cells("supquoteno").Value, "").ToString
            ...
            '  Obj_tbl_job.tbl_job_det(i).remark = Me.DgYarn.Rows(i).Cells("colRemLine").Value.ToString.Trim  ' Record does not has id
    ...
    Private Sub txtPurNo_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtPurNo.TextChanged
