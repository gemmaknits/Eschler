...
Public Class rptYarnLatestPrice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PurchaseOrderSystem.rptYarnLatestPrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptYarnLatestPrice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptYarnLatestPrice = New rptYarnLatestPrice()
        rpt.Site = Me.Site
        Return rpt
    End Function
