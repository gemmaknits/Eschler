...
Public Class clsConfig
    ...
    Public Sub PrintReportWithoutPreview(ByVal rptFileName As String, ByVal params As Hashtable, ByVal clsUser As classUserInfo, ByVal printerSettings As System.Drawing.Printing.PrinterSettings)
        If clsUser.ReportPath = "" Then clsUser.ReportPath = clsUser.ReportPath
        'clsUser.ReportPath = "C:\Users\DELL\Desktop\GemmaKnits\"
        If Not CheckReport(clsUser.ReportPath, rptFileName) Then Exit Sub
        ...
        For Each dict As DictionaryEntry In params
            rpt.SetParameterValue(dict.Key, dict.Value)
        Next
        ...
        rpt.PrintToPrinter(printerSettings, printerSettings.DefaultPageSettings, False)

    End Sub
    Public Function ConfirmExitPrg(pFormName As String) As Boolean
        'Sitthana 19/09/2018
        If MessageBox.Show("คุณยืนยันที่จะออกจากโปรแกรม " & pFormName & " ใช่หรือไม่ ?" _
                         , "ยืนยันที่จะออกจากโปรแกรม" _
