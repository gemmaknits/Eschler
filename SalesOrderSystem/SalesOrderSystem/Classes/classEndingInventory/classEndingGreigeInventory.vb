...
Public Class classEndingGreigeInventory
    ...
    Public Function EndingGreigeInventorySaveTmp(ByVal dtc As DataTable, ByRef Greige_header As Greige_Header, ByRef clsuser As classUserInfo)
    ...
    Public Function EndingGreigeInventorySave(ByRef dtc As DataTable, ByRef Message As String) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        comm.CommandText = "p_ending_greige_inventory_update_greige"
        j = 0
        For j = 0 To dtc.Rows.Count - 1
            With dtc.Rows
                comm.Parameters.Clear()
