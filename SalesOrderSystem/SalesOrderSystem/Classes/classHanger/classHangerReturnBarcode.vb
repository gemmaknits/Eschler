...
Imports System.Text
Public Class classHangerReturnBarcode
    Public Structure StrollsDHeader
        ...
        Dim h56_customer_id As Nullable(Of Int64)
        Dim h57_empcd As String
        'strolls_d
    End Structure
    Public Function GetHanger(Optional ByVal StrRollNoD As String = Nothing) As DataTable
        ...
        comm.CommandText = "P_HANGER_STOCK_IN_RETURN_PKG_get_hanger_by_tag"
    ...
    Public Function GetHangerByDINNO(Optional ByVal StrDINNO As String = Nothing) As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_HANGER_STOCK_IN_RETURN_PKG_get_hanger_by_dinno"
    ...
    Public Function MakeHangerIN(ByRef StrollsDHeader As StrollsDHeader, ByVal DV_ADD As DataView, ByVal DV_UPD As DataView, ByVal DV_DEL As DataView, ByRef msgerr As String, ByVal Userinfo As classUserInfo) As Boolean
        ...
        i = 0
        comm.CommandText = "P_HANGER_STOCK_IN_RETURN_PKG_update_strolls_d"
        ...
        For i = 0 To DV_ADD.Count - 1
            With DV_ADD
                ...
                comm.Parameters.AddWithValue("@dhcod", StrollsDHeader.h04_dhcod) 'add
                ...
                comm.Parameters.AddWithValue("@customer_id", StrollsDHeader.h56_customer_id)
                comm.Parameters.AddWithValue("@empcd", StrollsDHeader.h57_empcd)
        ...
        comm.CommandText = "P_HANGER_STOCK_IN_RETURN_PKG_delete_strolls_d"
