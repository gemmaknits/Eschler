...
Public Class classStockTransferD
    ...
    Public Function GetRollLocationD(ByVal StrRollNoD As String, ByVal StrLot As String) As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_get_strolls_d"
    ...
    Public Function GetTransferNoD() As DataTable
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_get_trn_no"
    ...
    Public Function GetTransferDetD(ByVal trn_no As String) As DataTable
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_select_dyed_transfer_det"
    ...
    Public Function Combomtllocations(Optional ByVal strUSerID As String = "",
        ...
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_get_mtl_locations"
    ...
    Public Function TrnDSave(ByRef TrnH As TrnHeader, ByVal TrnD_ADD As DataView, ByVal TrnD_UPD As DataView, ByVal TrnD_DEL As DataView, ByRef msgerr As String) As Boolean
        ...
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_update_dyed_transfer"
        ...
        comm.CommandText = "P_DYED_TRANSFER_PKG_update_dyed_transfer_det"
        ...
        For i = 0 To TrnD_ADD.Count - 1
            With TrnD_ADD
                ...
                comm.Parameters.AddWithValue("@old_mtl_warehouse_id", .Item(i)("old_mtl_warehouse_id"))
                comm.Parameters.AddWithValue("@old_mtl_subinventory_id", .Item(i)("old_mtl_subinventory_id"))
                comm.Parameters.AddWithValue("@old_mtl_locations_id", .Item(i)("old_mtl_locations_id"))
        ...
        i = 0
        comm.CommandText = "P_DYED_TRANSFER_PKG_cancel_dyed_transfer_det"
    ...
    Public Function TrnDCancel(ByVal trn_id As Long, ByVal loginempcd As String, ByRef StrMessage As String)
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        comm.Transaction = tran
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_DYED_TRANSFER_PKG_cancel_dyed_transfer"
