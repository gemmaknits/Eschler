...
Public Class classYarnLocation
    ...
    Public Function YarnLocationSaveHeader(ByRef strLogNo As String, _
                                            ByVal strLocationTo As String, _
                                            ByVal strActualMoveDate As String, _
                                            ByVal strReceiveDate As String, _
                                            ByVal Int64mtl_warehouse_id_fr As Nullable(Of Int64), _
                                            ByVal Int64mtl_subinventory_id_fr As Nullable(Of Int64), _
                                            ByVal Int64mtl_locations_id_fr As Nullable(Of Int64), _
                                            ByVal Int64mtl_warehouse_id_to As Nullable(Of Int64), _
                                            ByVal Int64mtl_subinventory_id_to As Nullable(Of Int64), _
