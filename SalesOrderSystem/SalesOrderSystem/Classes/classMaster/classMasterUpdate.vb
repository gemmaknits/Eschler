...
Public Class classMasterUpdate
    Public Structure endbuyers
        Dim endbuyercd As String
        Dim endbuyername As String
        Dim endbuyerid As Nullable(Of Int64)
    ...
    Public Structure Customer
        ...
        Dim h24_vat As String
        Dim h25_id_banks As Nullable(Of Int64)
    End Structure
    ...
    Public Structure cartons
        Dim h01_id As Nullable(Of Integer)
        Dim h02_dimension As String
        Dim h03_width As Nullable(Of Double)
        Dim h04_length As Nullable(Of Double)
        Dim h05_height As Nullable(Of Double)
        Dim h06_capacity As Nullable(Of Double)
        Dim h07_weight As Nullable(Of Double)
        Dim h08_Message As String
    ...
    Public Function CustomerSave(ByVal Cust As Customer, ByRef msgerr As String, ByRef CustCD As String) As Boolean
        ...
        With Cust
            ...
            comm.Parameters.AddWithValue("@vatregno", .h24_vat)
            comm.Parameters.AddWithValue("@id_banks", .h25_id_banks)
        End With
    ...
    Public Function SupplierSave(ByVal Supplier As Supplier, ByRef msgerr As String, ByRef SuppCD As String) As Boolean
        ...
        Return True
    End Function
    Public Function EndBuyerSave(dv_add As DataView, dv_upd As DataView, dv_del As DataView, ByRef EndBuyers As endbuyers) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        comm.CommandText = "p_endbuyers_insert"
        For i = 0 To dv_add.Count - 1
            With dv_add(i)
                comm.Parameters.AddWithValue("@endbuyercd", .Item("endbuyercd"))
                comm.Parameters.AddWithValue("@endbuyername", .Item("endbuyername"))
                comm.Parameters.AddWithValue("@endbuyerid", .Item("endbuyerid"))
            End With
            ...
            Try
                da.Fill(dt)
            Catch ex As Exception
                EndBuyers.Message = ex.Message
                tran.Rollback()
                conn.Close()  'Sitthana 20190325
                Return False
            End Try
            EndBuyers.endbuyerid = dt.Rows(0)("endbuyerid")
        Next
        ...
        comm.CommandText = "p_endbuyers_delete"
    ...
    Public Function CartonsSave(ByRef cartons As cartons, ByVal dv_add As DataView, ByVal dv_upd As DataView, ByVal dv_del As DataView) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        '=================================== Insert =========================================================================
        comm.CommandText = "p_mas_cartons_insert"

        For i = 0 To dv_add.Count - 1
            With dv_add
                comm.Parameters.Clear()
                comm.Parameters.AddWithValue("@id", dv_upd(i)("id").ToString.Trim)
                comm.Parameters.AddWithValue("@dimension", dv_upd(i)("dimension").ToString.Trim)
                comm.Parameters.AddWithValue("@width", dv_upd(i)("width").ToString.Trim)
                comm.Parameters.AddWithValue("@length", dv_upd(i)("length").ToString.Trim)
                comm.Parameters.AddWithValue("@height", dv_upd(i)("height").ToString.Trim)
                comm.Parameters.AddWithValue("@capacity", dv_upd(i)("capacity").ToString.Trim)
                comm.Parameters.AddWithValue("@weight", dv_upd(i)("weight").ToString.Trim)
            ...
            Try
                da.Fill(dt)
            Catch ex As Exception
                cartons.h08_Message = ex.Message
                tran.Rollback()
                conn.Close()  'Sitthana 20190325
                Return False
            End Try
        ...
        '=================================== Update =========================================================================
        comm.CommandText = "p_mas_cartons_update"
        ...
        '=================================== Update =========================================================================
        comm.CommandText = "p_mas_cartons_delete"
