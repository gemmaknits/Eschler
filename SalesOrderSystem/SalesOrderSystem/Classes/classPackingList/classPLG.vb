...
Public Class classPLG
    ...
    End Function
    Public Function plgsave(ByVal PLGHeader As PackingListGHeader, ByVal DV_DTC_ADD As DataView, ByVal DV_DTP_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTP_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByVal DV_DTP_DEL As DataView, ByRef msgerr As String, ByRef PLGNo As String, ByRef OUTREQNo As String, ByRef OUTNO As String, ByRef OUTDT As String, ByRef USERID As String, ByRef CheckNEW As String, ByRef Doc_Type As String) As Boolean
        ...
        For i = 0 To DV_DTP_ADD.Count - 1
            With DV_DTP_ADD
                'comm.Parameters.AddWithValue("@cartno", .h01_cartno)
                'comm.Parameters.AddWithValue("@packno", .h02_packno)
                'comm.Parameters.AddWithValue("@netwt", .h03_netwt)
                'comm.Parameters.AddWithValue("@grswt", .h04_grswt)
                'comm.Parameters.AddWithValue("@dimension", .h05_dimension)
                'comm.Parameters.AddWithValue("@gout", .h06_gout)
                'comm.Parameters.AddWithValue("@sel", .h07_sel)
                comm.Parameters.Clear()
                ...
                comm.Parameters.AddWithValue("@outno", config.IsNull(OUTNO.Trim, ""))
                comm.Parameters.AddWithValue("@outdt", config.IsNull(OUTDT, ""))
                ...
                comm.Parameters.AddWithValue("@packdt", OUTDT.Trim)
                ...
                comm.Parameters.AddWithValue("@preseted", "")
        ...
        Return True
    End Function
    Public Function plgsaveGOUT(ByVal PLGHeader As PackingListGHeader, ByVal DV_DTC_ADD As DataView, ByVal DV_DTP_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTP_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByVal DV_DTP_DEL As DataView, ByRef msgerr As String, ByRef PLGNo As String, ByRef OUTREQNo As String, ByRef OUTNo As String, ByRef OUTDT As String, ByRef USERID As String, ByRef CheckNEW As String, ByRef dtc As DataTable, ByRef dtp2 As DataTable, ByRef Doc_type As String) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        Return True
    End Function
    Public Function plgcancel(ByVal PLGHeader As PackingListGHeader, ByVal DV_DTC_ADD As DataView, ByVal DV_DTP_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTP_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByVal DV_DTP_DEL As DataView, ByRef msgerr As String, ByRef PLGNo As String, ByRef OUTREQNo As String, ByRef OUTNo As String, ByRef OUTDT As String, ByRef USERID As String, ByRef CheckNEW As String, ByRef dtc As DataTable, ByRef dtp As DataTable) As Boolean
        Dim config As New clsConfig
        Dim conn As New SqlConnection((New classConnection).connection)
        conn.Open()
        Dim tran As SqlTransaction = conn.BeginTransaction
        ...
        'OUTNo = dt.Rows(0)("packno").ToString.Trim
        'CheckNEW = dt.Rows(0)("checknew").ToString.Trim
        'End Gen PLG No----------
        'Start Add PLG----------
        comm.CommandText = "p_packing_list_g_insert_bin"
        i = 0
        For i = 0 To dtp.Rows.Count - 1
            With dtp.Rows
                ...
                comm.Parameters.AddWithValue("@outreqno", config.IsNull(.Item(i)("outreqno"), "")) 'Plese Check
                comm.Parameters.AddWithValue("@outreqdt", config.IsNull(.Item(i)("outreqdt"), ""))
                comm.Parameters.AddWithValue("@outreqtyp", "S")
        ...
        '    OUTNo = dtp_upd.Rows(0)("packno").ToString.Trim
        'Next
        'End Update PLG ----------
        ...
        'comm.CommandText = "p_packing_list_g_cartons_g_insert"
        'j = 0
        'For j = 0 To DV_DTC_ADD.Count - 1
        '    With DV_DTC_ADD
        '        comm.Parameters.Clear()
        ...
        'comm.CommandText = "p_packing_list_g_cartons_g_update"
        'j = 0
        'For j = 0 To DV_DTC_UPD.Count - 1
        '    With DV_DTC_UPD
        '        comm.Parameters.Clear()
        ...
        comm.CommandText = "p_packing_list_g_cartons_g_delete"
        j = 0
        For j = 0 To dtc.Rows.Count - 1
            With dtc.Rows
                comm.Parameters.Clear()
