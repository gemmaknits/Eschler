...
Public Class classCIN
    ...
    'Conversion Project
    Public Function selectStrollsDORecord(ByVal strOutNo As String, ByVal strEmpCode As String) As DataTable
        Dim conn As New SqlConnection((New ClassConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        '"p_strolls_d_in_return_select_outno"   'Old, 
        comm.CommandText = "P_CIN_FORM_PKG_select_strolls_d_o_record" 'Copy from gmk sitthana 24/09/2018
    ...
    'Conversion Project
    Public Function selectStrollsDList() As DataTable
        Dim conn As New SqlConnection((New ClassConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_CIN_FORM_PKG_select_strolls_d_list"
        comm.Parameters.Clear()
    ...
    Public Function selectStrollsDRecord(ByVal strdinNo As String, ByVal strEmpCode As String) As DataTable
        Dim conn As New SqlConnection((New ClassConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_CIN_FORM_PKG_select_strolls_d_record"
        comm.Parameters.Clear()
        comm.Parameters.AddWithValue("@dinno", strdinNo)
        comm.Parameters.AddWithValue("@logempcd", strEmpCode)
        Dim da As New SqlDataAdapter(comm)
    ...
    Public Function DReturnSave(ByVal Din_header As Strolls_DHeader, ByRef msgerr As String, ByVal dfc As DataTable, ByVal DV_DTC_ADD As DataView, ByVal DV_DTC_UPD As DataView, ByVal DV_DTC_DEL As DataView, ByRef UserID As String, ByRef DINno As String) As Boolean
        ...
        'Start Gen DIN No----------
        comm.CommandText = "P_CIN_FORM_PKG_generate_cinno"
        With Din_header
            comm.Parameters.Clear()
        ...
        comm.CommandText = "P_CIN_FORM_PKG_insert_strolls_d_record"
        j = 0
        For j = 0 To DV_DTC_ADD.Count - 1
            With DV_DTC_ADD
                If CBool(DV_DTC_ADD.Item(j)("selected")) Then
                    ...
                    comm.Parameters.AddWithValue("@roll_no_d", "") 'Gen New Roll No
        ...
        comm.CommandText = "P_CIN_FORM_PKG_update_strolls_d_record"
        j = 0
        ...
        comm.CommandText = "P_CIN_FORM_PKG_delete_strolls_d_record"
        j = 0
    ...
    Public Function DINcancel(ByVal Din_header As Strolls_DHeader, ByRef msgerr As String, ByVal dtp As DataTable, ByRef USERID As String) As Boolean
        ...
        'Start  Add PLD bin-----------
        comm.CommandText = "P_CIN_FORM_PKG_insert_strolls_d_bin_record"
        i = 0
