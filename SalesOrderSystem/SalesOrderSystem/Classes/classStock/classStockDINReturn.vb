...
Public Class classStockDINReturn
    ...
    Public Function GetDOut_Return(ByVal strOutNo As String, ByVal strEmpCode As String) As DataTable
        ...
        comm.CommandText = "p_din_return_select_outno" 'Copy from gmk sitthana 24/09/2018
    ...
    'Conversion Project
    Public Function GetComboDINNO() As DataTable
        Dim conn As New SqlConnection((New classConnection).connection)
        Dim comm As New SqlCommand("", conn)
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "p_strolls_d_in_return_select_dinno"
