Public Class frmDyingOrderPending
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		Const rptFileName = "rptDFOrderPending.rpt"
        ...
        If Me.optTBA.Checked Then rpt.SetParameterValue("@colorgroup", "TBA")
        If Me.optApproved.Checked Then rpt.SetParameterValue("@colorgroup", "APP")
        If Me.optAllColors.Checked Then rpt.SetParameterValue("@colorgroup", "ALL`")

        rpt.SetParameterValue("@AsOnDate", dtpAsOnDate.Value.ToString("yyyyMMdd"))

        rpt.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4
		rpt.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Portrait
		rpt.PrintOptions.PaperSource = CrystalDecisions.Shared.PaperSource.Auto

		frm.Title = "D/F Order Pending"
    ...
    Private Sub RadioButton1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optTBA.CheckedChanged
