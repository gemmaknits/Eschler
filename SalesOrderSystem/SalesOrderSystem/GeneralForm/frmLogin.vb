...
Public Class frmLogin
    ...
    Private Sub setComboWarehouse()
        ...
        cboWarehouse.SelectedValue = clsMaster.GetdefaultWarehouseID("")
    ...
    Private Function checkCanLoginAndKeepGlbValue()
        ...
        Else
            ...
            clsUser.ReportPath = ds.Tables("tableEmp").Rows(0)("report_path").ToString.Trim.ToUpper '"\\srv-gemmaknits\ESCHLER_REPORTS\" 'Sitthana 20220615  Temp.
            ...
            If oConfig.IsNull(clsUser.ExchangeRateUSD, 0) = 0 Then
                ...
                clsUser.ExchangeRate = clsUser.ExchangeRateUSD
