Public Class frmInvoiceLocalControl
	...
	Private Sub GenCombo()
        ...
        Me.cboSales.DataSource = objDB.GetEmp
        Me.cboSales.DisplayMember = "empname"
        Me.cboSales.ValueMember = "empcd"
	End Sub
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        rpt.SetParameterValue("@custcd", config.IsNull(cboCustomer.SelectedValue, ""))
        rpt.SetParameterValue("@empcd", config.IsNull(cboSales.SelectedValue, ""))
