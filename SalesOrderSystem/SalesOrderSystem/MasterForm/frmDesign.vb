Public Class frmDesign
	...
	Private Function SaveData() As Boolean
		If AllowEdit Or AllowNew Then
            ...
            header.h17_supdes_no = txtSuppDesignNo.Text.Trim
			header.h18_width = 0
			...
			If clsMaster.DesignSave(header, dv_add, dv_upd, dv_del, msgerr, design_no) Then
	...
	Private Sub btnViewImage_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnViewImage.Click
		If Len(strImagePath & strImageFilename) > 0 Then
			...
			frm.ImageFile = strImageFilename
			frm.ImagePath = strImagePath
			frm.ShowDialog()
		End If
	End Sub
	...
	Private Sub btnImagePath_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImagePath.Click
		...
		If strImagePath.Length = 0 Then
            ...
            Dim strFilePath As String = "P:\Images\"
		...
		dlg.InitialDirectory = strImagePath
    ...
    Private Sub cboDesignNo_Enter(sender As Object, e As EventArgs) Handles cboDesignNo.Enter
