...
Public Class frmPackingListGreige
    ...
    Private Const PresslessCustCd As String = "967"
    ...
    Function GetPackinglistGData(ByVal strPacking_no As String, StrCartno2 As String) As Boolean
        ...
        '    'Sitthana 20190601
        '    If Trim(clsconfig.IsNull(dt.Rows(0).Item("custcd"), "")) = PresslessCustCd Then
        '        cbPresslessShowBOI.Visible = True
        '        cbPresslessShowBOI.Checked = False
        '    Else
        '        cbPresslessShowBOI.Visible = False
        '    End If

        '    Return True
        'Else
        '    cbPresslessShowBOI.Visible = False 'Sitthana 20190601
        'End If
        'Return False
    ...
    Private Sub BindPackinglistGData(ByVal dt As DataTable)
        ...
        grdDataPackingList.AutoGenerateColumns = False
        grdDataPackingList.DataSource = dt
        grdDataPackingList.ScrollBars = ScrollBars.Both

        If grdDataPackingList.Rows.Count > 0 Then
            CboDoc_type.SelectedValue = (dt.Rows(0)("outreqtyp").ToString)
            DtpPackDate.Value = CDate(dt.Rows(0)("packdt").ToString)
            CustCd = (dt.Rows(0)("custcd").ToString) 'Sitthana 20190429
            txtcustomer.Text = (dt.Rows(0)("custname").ToString)
        Else
            CboDoc_type.SelectedIndex = -1
    ...
    Private Sub grdDataCartons_CellClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdDataCartons.CellClick
        'Call SumGrdPackingList() 'Comment By Sitthana 20220729
    End Sub
    ...
    Private Sub btnSearchPackno_Click(sender As System.Object, e As System.EventArgs) Handles btnSearchPackno.Click
        ...
        If Not blnCancel Then
            ...
            End If
            SumGrdPackingList() 'Sitthana 20220729
            SumCBM() 'Sitthana 20220729
        End If
        Me.Cursor = Cursors.Default
        frm.Dispose()
    End Sub
    ...
    Private Sub BtnCancel_Click(sender As System.Object, e As System.EventArgs) Handles BtnCancel.Click
        Call CancelPackinglistG()
    End Sub
    Private Sub CancelPackinglistG()
        If txtPackNo.Text.Trim = "" Then Exit Sub
    ...
    Private Function CancelPLG() As Boolean
        ...
        PLGHeader.h02_packno = txtPackNo.Text


        If (New classPackingListG).plgcancel(PLGHeader, clsuser.UserID, msgerr) Then
            MessageBox.Show("คุณยกเลิก Packno No. : " & txtPackNo.Text.Trim & " สำเร็จ ! ", "System Message", MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1)
            CancelPLG = True
        Else
    ...
    Private Function SavePLG() As Boolean
        ...
        PLGHeader.h02_packno = txtPackNo.Text.Trim
        PLGHeader.h20_outno = txtOutNo.Text.Trim
        If oConfig.IsNull(PLGHeader.h20_outno.Trim, "") <> "" Then
            PLGHeader.h21_outdt = DtpOutdt.Value.ToString("dd-MM-yyyy")
        ElseIf oConfig.IsNull(PLGHeader.h20_outno.Trim, "") = "" Then
        ...
        If objdb.plgsave(PLGHeader:=PLGHeader, dv_dtc_add:=dv_dtc_add, dv_dtc_upd:=dv_dtc_upd, dv_dtc_del:=dv_dtc_del,
                         dv_dtp_add:=dv_dtp_add, dv_dtp_upd:=dv_dtp_upd, dv_dtp_del:=dv_dtp_del, msgerr:=msgerr, PLGNo:=PLGNo, OUTREQNo:=OUTREQNo,
    ...
    Private Sub BtnPrint_Click(sender As System.Object, e As System.EventArgs) Handles BtnPrintPLG.Click
        ...
        Select Case CustCd.Trim
            Case PresslessCustCd
                If cbPresslessShowBOI.Checked Then
                    rptFileName = "rptPLGPresslessShowBOI.rpt"
                Else
    ...
    Private Sub BtnYarnPrintBar_Click(sender As Object, e As EventArgs) Handles BtnPrintBarcode.Click
        ...
        Select Case CustCd.Trim
            Case PresslessCustCd
                printReport("rptGreigeOutBarcodePressless.rpt")
            Case Else
                printReport("rptGreigeOutBarcode.rpt")
        End Select
    End Sub

    Private Sub PLGStdToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PLGStdToolStripMenuItem.Click
        strPacking_no = txtPackNo.Text
        If strPacking_no = "" Then strPacking_no = txtPackNo.Text
        If strPacking_no.Length = 0 Then Exit Sub
    ...
    Private Sub PLGPToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PLGPToolStripMenuItem.Click
        strPacking_no = txtPackNo.Text
        If strPacking_no = "" Then strPacking_no = txtPackNo.Text
        If strPacking_no.Length = 0 Then Exit Sub
    ...
    Private Sub PLGPresslessShowBOIToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PLGPresslessShowBOIToolStripMenuItem.Click
        strPacking_no = txtPackNo.Text
        If strPacking_no = "" Then strPacking_no = txtPackNo.Text
        If strPacking_no.Length = 0 Then Exit Sub
    ...
    Private Sub GOStdToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GOStdToolStripMenuItem.Click
        'strPacking_no = txtPackNo.Text
        'If txtOutNo.Text = "" Then strPacking_no = txtPackNo.Text
        If txtOutNo.Text.Length = 0 Then Exit Sub
        Const rptFileName = "rptGOut.rpt"
    ...
    Private Sub TagStdToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TagStdToolStripMenuItem.Click
    ...
    Private Sub TagPressToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TagPressToolStripMenuItem.Click
    ...
    Private Sub TsmnShowSentToCustToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TsmnShowSentToCustToolStripMenuItem.Click
        If txtOutNo.Text.Trim.Length = 0 Then
            MessageBox.Show("คุณยังไมได้ทำ GOUT", "System Message", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            Exit Sub
        End If
        ...
        printReport("rptStockGBarcodeShowSentToCust.rpt")
    End Sub

    Private Sub TagInterSpitzenAGToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TagInterSpitzenAGToolStripMenuItem.Click
        If txtOutNo.Text.Trim.Length = 0 Then
            MessageBox.Show("คุณยังไมได้ทำ GOUT", "System Message", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
            Exit Sub
        End If
        ...
        printReport("rptStockGBarcodeInterSpitzenAG.rpt")
    End Sub
End Class