...
#End Region
    ...
    Private clsRequest As New classRequest 'Sitthana 20240805
    Private clsPackingListG As New classPackingListG 'Sitthana 20240805
    ...
    Private Sub GenComboReqNo()
        ...
        cboReqNo.ComboBox.DataSource = objDB.GetReqNo("G")
    ...
    Private Sub BindData(ByVal dt As DataTable)
        ...
        'Sitthana 20240805 get packno
        Dim dtPack As New DataTable
        dtPack = clsRequest.getPackNoByGReqNo(txtReqNo.Text.Trim)
        If dtPack.Rows.Count > 0 Then
            txtPackNo.Text = dtPack.Rows(0)("packno")
            txtOutNo.Text = dtPack.Rows(0)("outno").ToString.Trim()
        Else
            txtPackNo.Text = ""
            txtOutNo.Text = ""
        End If
    ...
    Private Function SaveData() As Boolean
        ...
        header.h20_stock_type = "G"
        header.h21_cancel_status = False

        If clsReq.ReqGSave(header, dv_add, dv_upd, dv_del, msgerr, reqno) Then
            strReqNo = reqno
            SaveData = True
        Else
    ...
    Private Sub ClearGrdDesign()
        ...
        'grdDesign.DataSource = objDB.ReqGGetSODesignGrid("Nothing", "Nothing")
        grdDesign.DataSource = objDB.ReqGGetSODesignGrid("", "")
    End Sub
    ...
    Private Sub ClearGrdStock()
        ...
        grdFreeStockD.DataSource = objDB.ReqGGetSTK("")
    ...
    Private Sub ClearGrdReq()
        ...
        grdReqDetD.DataSource = objDB.ReqDetGLoad("")
    End Sub
    ...
    Private Sub frmRequestG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmRequestG_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        frm.Title = "Request Stock Greige"
    ...
    Private Sub cboReqNo_DropDownClosed(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboReqNo.DropDownClosed
        ...
        End If
        Dim ReqNo As String
        ReqNo = clsConfig.IsNull(cboReqNo.ComboBox.SelectedValue, "")
        If ReqNo.Substring(0, 2) = "RG" Then
            If ReqNo.Trim.Length > 0 Then
                Call btnNew_Click(sender, e)
                If Not blnCancel Then LoadData(ReqNo)
            End If
        Else
            MessageBox.Show("This Form Can Request Only Greige Stock." & vbCrLf & "หน้าจอนี้ใช้เฉพาะ Request Stock D เท่านั้น", "System Message", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
        End If
    End Sub
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If MessageBox.Show("Would you like to add selected Roll No. from left grid to right grid ?" & vbCrLf & "คุณต้องการเพิ่มม้วนที่เลือกไว้ด้านซ้ายเพื่อนำไปด้านขวาใช่หรือไม่ ?", "System Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No Then Exit Sub
        Call AddRollNo()
    End Sub
    ...
    Private Sub cboDesignNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboDesignNo.KeyDown
    ...
    Private Sub getStockData()
        ...
        Dim objDB As New classRequest
        grdDesign.AutoGenerateColumns = False
        grdDesign.DataSource = objDB.ReqGGetSODesignGrid(clsConfig.IsNull(cboSoNo.SelectedValue, "Nothing").ToString.Trim, clsConfig.IsNull(cboDesignNo.Text.Trim, "Nothing").ToString.Trim)
        'grdDesign.DataSource = objDB.GetSODesignGrid3(clsConfig.IsNull(cboSoNo.SelectedValue, "Nothing").ToString.Trim, clsConfig.IsNull(cboDesignNo.Text.Trim, "Nothing").ToString.Trim)
        Call ClearGrdStock()
        Call SumGridStock()
    ...
    Private Sub grdDesign_CellBorderStyleChanged(sender As Object, e As System.EventArgs) Handles grdDesign.CellBorderStyleChanged
    ...
    Private Sub grdDesign_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdDesign.CellClick
        ...
        grdFreeStockD.AutoGenerateColumns = False
        grdFreeStockD.DataSource = objDB.ReqGGetSTK(strReqNo,
          ...
          config.IsNull(grdDesign.Rows(e.RowIndex).Cells("ds_col").Value, "").ToString.Trim,
    ...
    Private Sub btnShowLockedStock_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShowLockedStock.Click
        Dim frm As New frmRequestGOnhand
    ...
    Private Sub txtBarcode_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles txtBarcode.KeyDown
        ...
        Dim config As New clsConfig
        Dim objDB As New classRequest
        Dim dt As DataTable = objDB.GetRollNoG(strReqNo,
    ...
    'Create Packing List & Greige Out
    ...
    Private Sub btnSavePackNo_Click(sender As Object, e As EventArgs) Handles btnSavePackNo.Click
        If cboDocType.SelectedValue = "M" Then
            ...
            Else
                ...
                Dim frm As New frmPackingListGreigeRelateRequest
    ...
    Private Sub btnSearchReqNo_Click(sender As Object, e As EventArgs) Handles btnSearchReqNo.Click
        Dim frm As New frmRequestSearch
        frm.pStockType = "G"
        frm.ShowDialog(Me)
        Call btnNew_Click(sender, e)
