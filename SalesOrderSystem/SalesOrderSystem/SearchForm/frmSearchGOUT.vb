Public Class frmSearchGOUT
    ...
    End Sub
    Private Sub GenGrid()
        Dim objDB As New classSearchGOUT
    ...
    Private Sub frmSearchGOUT_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub grdData_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdData.CellContentClick
        'If grdData.Rows.Count > 0 Then strOutNo = grdData.CurrentRow.Cells("outno").Value
        'Me.Hide()
        'End
    End Sub

    Private Sub grdData_CellDoubleClick(sender As Object, e As System.EventArgs) Handles grdData.CellDoubleClick
        If grdData.Rows.Count > 0 Then strOutNo = grdData.CurrentRow.Cells("outno").Value
        Me.Hide()
