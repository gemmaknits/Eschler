Public Class frmSearchPLD
    ...
    Private Sub GenGrid()
        ...
        End If
        grdPackinglistD.AutoGenerateColumns = False
        grdPackinglistD.DataSource = dt
    End Sub
    ...
    Private Sub grdPackinglistD_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdPackinglistD.CellContentClick
        ' If grdPackinglistG.Rows.Count > 0 Then strPackNo = grdPackinglistG.CurrentRow.Cells("grdPackinglistG_packno").Value
        ' Me.Hide()
        ' End
    End Sub

    Private Sub grdPackinglistD_CellDoubleClick(sender As Object, e As System.EventArgs) Handles grdPackinglistD.CellDoubleClick
        If grdPackinglistD.Rows.Count > 0 Then strPackNo = grdPackinglistD.CurrentRow.Cells("grdPackinglistD_packno").Value
        Me.Hide()
