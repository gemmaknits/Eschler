Public Class frmSearchREQG
    ...
    Private Sub GenGrid()
        ...
        dt = objDB.SearchOutReqNo(strStockType, txtReqNo.Text.Trim.ToUpper, dtpDateFr.Value.ToString("yyyyMMdd"), dtpDateTo.Value.ToString("yyyyMMdd"), clsConfig.IsNull(cboCustomer.SelectedValue, "").ToString.Trim.ToUpper, clsConfig.IsNull(CboDoc_type.SelectedValue, ""))
        If dt.Rows.Count > 0 Then
            strReqNo = dt.Rows(0)("outreqno")
            'grdReq.Rows = dt.Rows(0)("outreqtyp").ToString()
        End If
    ...
    Private Sub frmSearchREQG_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToParent()
