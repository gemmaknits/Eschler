...
Public Class frmEndingYarnInventory
    ...
    Private Sub GenCombo()
        ...
        mtl_subinventory.DataSource = objdb.ComboMtlsubinventory("0")
    ...
    Private Sub InitControl()
        ...
        'GenCombo()
        txtBarcode.Focus()
        If clsUser.UserID.ToUpper = "JIEW" Or clsUser.UserID.ToUpper = "STOCK" Then
            gbApplyDataRemark.Enabled = True
            'txtRemark.ReadOnly = False
            'txtRemark.Enabled = True
            'btnApplyAll.Enabled = True
            'btnApplyCurRow.Enabled = True
        Else
            gbApplyDataRemark.Enabled = False
            'txtRemark.ReadOnly = True
            'txtRemark.Enabled = False
            'btnApplyAll.Enabled = False
            'btnApplyCurRow.Enabled = False
        End If
    End Sub
...
ExitSub:
    ...
    Private Sub grdData_CellEndEdit(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdData.CellEndEdit
        ...
        'grdData.CurrentRow.Cells("loc").Value = grdData.CurrentRow.Cells("mtl_locations").FormattedValue.ToString()
    End Sub
    ...
    Private Sub ApplyRow(RowNo As Integer)
        With grdData
            grdData.Rows(RowNo).Cells("dye_test_result").Value = IIf(optNone.Checked, "N", IIf(optPassed.Checked, "P", "F"))
            grdData.Rows(RowNo).Cells("box_remark").Value = txtRemark.Text.Trim
        End With
    End Sub
