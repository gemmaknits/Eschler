    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        If MessageBox.Show("Would you like to Generate Packing List ?", "System Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            If GenPackingList(StockDClearanceSale_Header) Then
                MessageBox.Show("S/O No. = " & StockDClearanceSale_Header.sono & vbCrLf &
                        "Pack No. = " & StockDClearanceSale_Header.packno & vbCrLf &
...
ExitSub:
    ...
    Private Sub grdData_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles grdData.CellEndEdit
        Call SumGrdData()
    End Sub
End Class