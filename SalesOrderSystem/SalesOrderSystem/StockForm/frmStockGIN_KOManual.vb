...
Public Class frmStockGIN_KOManual
    ...
    Private Sub GenCbo()
        ...
        If clsConfig.IsNull(cbomtl_warehouse.SelectedValue, 0) = 0 Then SetDefaultWarehouse(cbomtl_warehouse.DataSource)

        cbomtl_subinventory.DataSource = objdb.ComboMtlsubinventory(cbomtl_warehouse.SelectedValue)
        ...
        cbomtl_location.DataSource = objdb.Combomtllocations(strUSerID:=clsUser.UserID, INt64mtl_warehouse_id:=cbomtl_warehouse.SelectedValue, Int64mtl_subinventory_id:=2)
        ...
        Me.cbodefect_code.DataSource = objdb2.GetDefect_Code
    ...
    Private Function getGIN(ByVal StrTran_no As String) As Boolean
        ...
        'dtdefect = dbStockG.GetDefectRoll(txtroll_no.Text, clsUser.UserID)
    ...
    Private Function SaveGINKOManual(Optional ByVal strGINNO As String = "") As Boolean
        ...
        Greige_Header.h25_loc = clsConfig.IsNull(cbomtl_location.Text.Trim, "")
