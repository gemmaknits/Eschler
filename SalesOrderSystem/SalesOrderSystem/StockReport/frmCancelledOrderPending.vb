Public Class frmCancelledOrderPending
    ...
    Private Sub frmCancelledOrderPending_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Dim rptFileName = "rptCancelledOrderPending.rpt"
        ...
        frm.Title = "Cancelled Order Pending"
