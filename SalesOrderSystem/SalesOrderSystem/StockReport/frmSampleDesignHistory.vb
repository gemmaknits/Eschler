Public Class frmSampleDesignHistory
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        'Const rptFileName = "rptSampleStockBalance.rpt"
        Const rptFileName = "rptSampleDesignHistory.rpt"
        ...
        ElseIf optPrintExcept.Checked Then
            ...
            rpt.SetParameterValue("@mtl_locations_id", (New clsConfig).IsNull(cbomtlLocation.SelectedValue, 0))
        End If
        rpt.SetParameterValue("@mtl_inventory_types_id", (New clsConfig).IsNull(cbomtl_inventory_types.SelectedValue, DBNull.Value))
    ...
    Private Sub GenCombo()
        ...
        Me.cbomtl_inventory_types.DataSource = (New classMaster).GetCombomtl_inventory_types()
