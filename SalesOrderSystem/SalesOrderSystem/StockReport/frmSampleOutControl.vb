Public Class frmSampleOutControl
    ...
    Private Sub btnPrint_Click(sender As System.Object, e As System.EventArgs) Handles btnPrint.Click
        'Dim rptFileName As String = "rptSampleOutControl.rpt"
        Dim rptFileName As String = "rptSampleOutControlByDetail.rpt"

        If ChkDetail.Checked Then
            rptFileName = "rptSampleOutControlByDetail.rpt"
        ElseIf ChkGroupByDesign.Checked Then
            rptFileName = "rptSampleOutControlGroupByDesignNo.rpt"
        End If

        'Const rptFileName = "rptSampleOutControl.rpt"
        ...
        ElseIf optPrintExcept.Checked Then
            ...
            rpt.SetParameterValue("@mtl_locations_id", (New clsConfig).IsNull(cbomtlLocation.SelectedValue, 0))
        End If
        If Not chkNoneDom.Checked Then
            rpt.SetParameterValue("@do_type", 0)
        Else
            rpt.SetParameterValue("@do_type", 1)
        End If
