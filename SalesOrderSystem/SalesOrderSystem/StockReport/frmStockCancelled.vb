Public Class frmStockCancelled
	Dim clsConn As New classConnection
	Dim clsConfig As New clsConfig
	Dim clsUser As New classUserInfo
	Dim strStockType As String = "YIN"
	...
	Private Sub frmStockCancelled_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
	...
	Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
		Dim rptFileName As String = "rptStockCancelled.rpt"
		...
		rpt.VerifyDatabase()
		rpt.SetParameterValue("@stock_type", strStockType)
		...
		frm.Title = "Stock Cancelled Report"
	...
	Private Sub RadioButton1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
	  ...
	  RadioButton6.CheckedChanged, _
	  RadioButton7.CheckedChanged, _
	  RadioButton8.CheckedChanged
		strStockType = DirectCast(sender, RadioButton).Tag
	End Sub
End Class