...
Public Class rptInvExportControl
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInvExportControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvExportControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvExportControl = New rptInvExportControl
        rpt.Site = Me.Site
        Return rpt
    End Function
