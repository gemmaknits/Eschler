...
Public Class rptStockCBalanceAudit
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockCBalanceAudit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockCBalanceAudit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockCBalanceAudit = New rptStockCBalanceAudit
        rpt.Site = Me.Site
        Return rpt
    End Function
