...
Public Class rptStockCOnhand_detail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockCOnhand_detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockCOnhand_detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockCOnhand_detail = New rptStockCOnhand_detail
        rpt.Site = Me.Site
        Return rpt
    End Function
