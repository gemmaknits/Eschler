...
Public Class rptStockCOnhand_exclusive
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockCOnhand_exclusive.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_custcd_type() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockCOnhand_exclusive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockCOnhand_exclusive = New rptStockCOnhand_exclusive
        rpt.Site = Me.Site
        Return rpt
    End Function
