...
Public Class rptStockCOnhand_summary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockCOnhand_summary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockCOnhand_summary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockCOnhand_summary = New rptStockCOnhand_summary
        rpt.Site = Me.Site
        Return rpt
    End Function
