...
Public Class rptStockDBalanceAudit
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockDBalanceAudit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockDBalanceAudit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockDBalanceAudit = New rptStockDBalanceAudit
        rpt.Site = Me.Site
        Return rpt
    End Function
