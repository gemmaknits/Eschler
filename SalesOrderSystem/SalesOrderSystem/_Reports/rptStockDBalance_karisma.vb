...
Public Class rptStockDBalance_karisma
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockDBalance_karisma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockDBalance_karisma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockDBalance_karisma = New rptStockDBalance_karisma
        rpt.Site = Me.Site
        Return rpt
    End Function
