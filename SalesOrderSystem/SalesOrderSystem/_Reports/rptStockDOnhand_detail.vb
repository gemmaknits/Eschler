...
Public Class rptStockDOnhand_detail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockDOnhand_detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockDOnhand_detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockDOnhand_detail = New rptStockDOnhand_detail
        rpt.Site = Me.Site
        Return rpt
    End Function
