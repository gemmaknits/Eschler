...
Public Class rptStockDPendingCutting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockDPendingCutting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockDPendingCutting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockDPendingCutting = New rptStockDPendingCutting
        rpt.Site = Me.Site
        Return rpt
    End Function
