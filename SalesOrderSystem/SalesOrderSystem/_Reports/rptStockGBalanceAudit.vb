...
Public Class rptStockGBalanceAudit
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockGBalanceAudit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockGBalanceAudit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockGBalanceAudit = New rptStockGBalanceAudit
        rpt.Site = Me.Site
        Return rpt
    End Function
