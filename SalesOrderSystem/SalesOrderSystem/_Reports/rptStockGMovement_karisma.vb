...
Public Class rptStockGMovement_karisma
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockGMovement_karisma.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_doc_type() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptStockGMovement_karisma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockGMovement_karisma = New rptStockGMovement_karisma
        rpt.Site = Me.Site
        Return rpt
    End Function
