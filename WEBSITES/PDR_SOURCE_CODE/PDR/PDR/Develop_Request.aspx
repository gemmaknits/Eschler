...
<asp:HiddenField ID="hidSearchMainValue" runat="server" />
    ...
    <div style="left:50px; top:60px; width:400px;position:absolute; margin-top: 0px;" >
        <Table ID="Table1" runat="server">
        <tr>
             <td> <strong> <asp:Label ID="Label1" runat="server" Text="DEVELOP REQUEST" Font-Size="12.25pt"></asp:Label></strong></td>
             <td style="padding-left:20px">
                  <a  target="_self"  href="Develop_Request.aspx">
                            <asp:ImageButton ID="ImgAdd" runat="server" Width="35px" Height="35px" ImageUrl="~/Images/add-icon.png" href="Develop_Request.aspx?pdrno=''" OnClick="ImgAdd_Click"/>
             </td>
             <td style="padding-left:20px">
                  <a  target="_self"  href="Develop_Request.aspx">
                            <asp:ImageButton ID="ImgSave" runat="server" Width="35px" Height="35px"  ImageUrl="~/Images/Save-as-icon.png" href="Develop_Request.aspx" OnClick="ImgSave_Click"/>
             </td>
             <td style="padding-left:20px">
                  <a  target="_self"  href="Develop_Request.aspx">
                            <asp:ImageButton ID="ImgPrint" runat="server" Width="35px" Height="35px" ImageUrl="~/Images/Printer-icon.png" href="PDR_List.aspx" OnClick="ImgPrint_Click"/>
             </td>
            <td style="padding-left:20px">
                  <a  target="_self"  >
                            <asp:ImageButton ID="ImageButton3" runat="server" Width="35px" Height="35px" ImageUrl="~/Images/EMail.jpg"  OnClick="ImgEMail_Click"/>
             </td>
             ...
             <table style="line-height:28px;">
                    <tr>
                        ...
                        <td style="padding-left:45px">
                             <INPUT class="datepicker TextBox" id="PDRDate"  type="text" size="10" name="PDRDate" runat="server" style="width:90px" >
                        </td>
                    </tr>
                </table>
        </div>
  ...
  target="_blank" ></asp:LinkButton>--%>
                      <a  target="_blank"  href="addeditcustomer.aspx">
                            <asp:ImageButton ID="ImageButton1" runat="server" Width="20px" Height="20px" ImageUrl="~/Images/add-icon.png"  
        ...
        <div style="left: 50px;
             ...
             position: absolute;">
             <strong>
             <asp:Label ID="Label15" runat="server" Text="CUSTOMER REQUIRE" BackColor="#999999" Width="200px"></asp:Label>
             </strong>
            </div>
    ...
    <div style="left:50px; top:288px; width:1178px; position:absolute">
        <strong>
        <asp:Label ID="Label16" runat="server" Text="ITEM CATEGORY" BackColor="#999999" Width="200px"></asp:Label>
        </strong>
     </DIV>
    <div style="left:50px; top:318px; width:1388px; position:absolute; height: 50px;">
        ...
        <table style="width: 1160px">
            ...
            <tr style="line-height:28px;">
               <td style="width:200px">
                     <asp:Label ID="Label8" runat="server" Text="CATEGORY" Width="200px" CssClass="clsFromLabel"></asp:Label>
                </td>
                <td style="padding-right:20px">
  ...
  <div style="left:50px; top:381px; width:1395px; position:absolute">
      ...
      <table>
            <tr style="line-height:25px;">
               <td style="width:200px">
                       <strong>
                    <asp:Label ID="Label19" runat="server" Text="TEST METHOD:" BackColor="#999999" Width="200px"></asp:Label>
                    </strong>
                </td>

                <td style="padding-right:10px">
                    <asp:CheckBox ID="CHKAATCC" CssClass="chkcol" Width="100px" runat="server" Text="AATCC" />
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="CHKASTM" CssClass="chkcol" Width="100px" runat="server" Text="ASTM"/>
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="CHKISO" CssClass="chkcol" Width="100px" runat="server" Text="GMK"/>
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="CHKJIS" CssClass="chkcol" Width="100px" runat="server" Text="JIS" />
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="chkMS" CssClass="chkcol" Width="100px"  runat="server" Text="M & S"/>
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="chkHM" CssClass="chkcol" Width="100px" runat="server" Text="HM" />
                </td>
                 <td style="padding-right:10px">
                    <asp:CheckBox ID="chkVSS" CssClass="chkcol" Width="100px" runat="server" Text="VSS" />
                </td>
                <Td >
    ...
    <div style="left: 540px; top: 430px; width: 300px; position: absolute;">
        <table style="line-height:25px;">
            <tr >
                <td>
            ...
            <tr style="line-height:25px;">
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail1" runat="server" Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail2" runat="server" Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail3" runat="server" Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail4" runat="server"  Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail5" runat="server" Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td style="padding-left:10px">
                    <asp:TextBox ID="txtAvail6" runat="server" Width="100px" CssClass="TextBox"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style=" left: 930px;
        ...
        <asp:GridView ID="gvDevelop_Request" runat="server" AutoGenerateColumns="false" emptydatatext="There is No Records To Display"
            ...
            appl_id,sub_appl_id,spl_func_id,ctry,market_zone_id,market_customer_id" Width="809px" OnRowDeleting="OnRowDeleting">
            <RowStyle Height="25" />
            <PagerStyle Height="25" />
            <HeaderStyle CssClass="grdheader" />
            <Columns>
                <asp:TemplateField ItemStyle-Width="120px" HeaderText="APPL" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                ...
                <asp:TemplateField ItemStyle-Width="120px" HeaderText="SUB APPL" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                ...
                <asp:TemplateField ItemStyle-Width="120px" HeaderText="SPL.FUNC" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                ...
                <asp:TemplateField ItemStyle-Width="120px" HeaderText="CTRY" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                        <asp:DropDownList ID="ddlctry" runat="server" Width="120px" DataTextField="ctry_name" DataValueField="ctry" style="border:none"/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-Width="120px" HeaderText="ZONE" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                 ...
                 <asp:TemplateField ItemStyle-Width="120px" HeaderText="CUSTOMER" HeaderStyle-CssClass="col" ItemStyle-CssClass="col TextBox" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Font-Bold="false">
                    <ItemTemplate>
                 ...
                 <asp:CommandField ShowDeleteButton="True" ButtonType="Button" ControlStyle-CssClass="button" />
            </Columns>
        </asp:GridView>
    </div>
        ...
        <table style="line-height:25px;">
            <tr>
                <td style="width:150px">
                    <asp:Label ID="Label25" runat="server" Text="WEIGHT(G/M)" Width="150px" CssClass="clsFromLabel"></asp:Label>
        ...
        <table style="line-height:25px;">
            <tr>
                <td><asp:Label ID="Label51" runat="server" Text="Tol" CssClass="clsFromLabel"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
                 <td><asp:TextBox ID="txtweightTolerance" runat="server" Text="" CssClass="TextBox numericcol"  Width="60px" onkeydown="return jsDecimals(event);"></asp:TextBox></td>
    ...
    <div style="left:677px; top:717px; width:328px; position:absolute; height: 120px;">
        <table style="line-height:25px;">
             <tr>
    ...
    <div style="left:50px; top:952px; width:296px; position:absolute; height: 18px;" >
      ...
      <div style="left:50px; top:976px; width:296px; position:absolute; height: 46px;" >
        <table cellspacing="10px" style="width: 290px">
            <tr>
                <td >
                    <asp:Label ID="Label39" runat="server" Text="DYE IN COLOR:" Width="200px" CssClass="clsFromLabel"></asp:Label>
                </td>
     ...
     <div style="left:450px; top:1030px; width:296px; position:absolute; " >
        <table style="width: 292px; ">
            <tr>
                ...
                <td  >
                   <asp:TextBox ID="TXTYARDAGE" CssClass="TextBox numericcol" runat="server" onkeydown="return jsDecimals(event);"></asp:TextBox></td>
            </tr>
            ...
            <tr>
                <td><asp:Label ID="LBLATTACH" runat="server" Text="ATTACHED SUPPORT DOC" CssClass="clsFromLabel"></asp:Label></td>
                 <td style="width:400px">
                     ...
                     <%--<input ID="uploadfiles1" type="file" name="file" onchange="previewFile()"  runat="server" />--%>
                    
                     </td>
                <td>
                 <%-- <a  target="_blank"  href="fileopen.aspx">  --%>
                      <asp:Button ID="btnView" runat="server" Text="View" CssClass="button"  OnClientClick="previewFile()" OnClick="btnView_Click"   /></a>
                    <asp:Image ID="img" runat="server" />
                </td>
                
                <%--  <a  target="_blank"  href="fileopen.aspx" >
                          <img id="ctl00_XXX" src="/Images/Edit.ico" style="border-width:0px;"  Height="20px" Width="20px"  />
                      </a>--%>
               <%-- <td>
