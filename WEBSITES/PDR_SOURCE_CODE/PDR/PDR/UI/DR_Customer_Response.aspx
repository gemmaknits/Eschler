<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DR_Customer_Response.aspx.cs" Inherits="PDR.UI.DR_Customer_Response" %>
    ...
    <div style="position: absolute; top: 140px; left: 5px">
        <table>
            <tr>
                ...
                <tr>
                <td>
                    <asp:Label ID="Label8" runat="server" Text="REF NO" CssClass="clsFromLabel"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtrefno" runat="server" CssClass="TextBox" Width="290px"></asp:TextBox>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a target="_blank">
                     ...
                     <a target="SendMail_Customer_Response.aspx">
     ...
     <div class="col-sm-10" style="margin-left: 7px; padding-left: 7px; left: 17px;top:480px">
      ...
      <div id="dvProgressBar" style="visibility: hidden; left: 100px">
            <img src="~/Images/progress_bar.gif" runat="server" style="left: 200px; position: absolute; top: 500px;" />
        </div>
        <div style="top: 511px; left: 241px; position: absolute;">
            <strong>
