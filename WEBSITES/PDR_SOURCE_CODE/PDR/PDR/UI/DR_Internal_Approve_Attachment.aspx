<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DR_Internal_Approve_Attachment.aspx.cs" Inherits="PDR.UI.DR_Internal_Approve_Attachment" %>
                 ...
                 <div class="row " style="margin-left: 5px; padding-left: 5px; left: 5px">
                    <div class="form-group form-inline " style="margin-left: 5px; padding-left: 5px; left: 5px">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <label class="clsFromLabel" for="txtEstimateNo" style="width: 100px">DOCUMENT NO</label></td>
                            ...
                            <tr>
                                <td>
                                    <label class="clsFromLabel" for="txtProduct" style="width: 100px">PRODUCT</label></td>
                                <td class="auto-style2">
                            ...
                            <tr>
                                <td>
                                    <label class="clsFromLabel" for="txtDescription" style="width: 100px">DESCRIPTION</label></td>
                                <td class="auto-style2">
