...
<body>
    ...
    <div>
        ...
        <tr>
            ...
            <td>
             <asp:TextBox ID="txtUserName" runat="server" CssClass="TextBox col" style="height:20px" Text=""></asp:TextBox>
        ...
        <tr>
            ...
            <td style="margin-left: 40px">
                <asp:TextBox ID="txtPWD" runat="server" TextMode="Password" CssClass="TextBox col" style="height:20px" Text=""></asp:TextBox>
