<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendMail_Customer_Response.aspx.cs" Inherits="PDR.UI.SendMail_Customer_Response" %>
<!DOCTYPE html>
    ...
    <form id="frmSendMailKnittingApproval" runat="server">
        ...
        <div style="top: 611px; left: 211px; position: absolute;">
           ...
           <div  style="top: 643px; left: 55px; position: absolute;">
              <asp:GridView ID="grdAttachmentDetails" runat="server" AutoGenerateColumns="false" GridLines="None" OnRowCommand="OnRowCommand" DataKeyNames="doc_attachments_id,source_doc_number,file_location"
                    Width="32%">
