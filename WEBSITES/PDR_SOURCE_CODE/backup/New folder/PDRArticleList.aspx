        ...
        <div class="row">
            ...
            <div class="col-xs-12" style="padding-left: 0px !important; padding-right: 0px !important; overflow-x: visible !important; height: 100%;">
                   <ej:grid ID="grdArticleList" runat="server" AllowScrolling="true" AllowPaging="false">
                       ...
                       <Columns>
                            <ej:Column Field="design_no" HeaderText="Design No." Type="string" Width="60"/>
                            <ej:Column Field="article_name" HeaderText="Article Name"  Type="string" Width="100"  />
                            <ej:Column Field="xl_material"  Type="string" HeaderText="Composition"  Width="100" />
                            <ej:Column Field="itptype" Type="string" HeaderText="End Use Type"  Width="100" />
                            <ej:Column Field="itpvalue" Type="string" HeaderText="End Use Name"  Width="100" />
                            ...
                            <ej:Column Field="xl_description"  Type="string" HeaderText="Description" Width="100"/>
                            <ej:Column Field="MIN_THB_KG"  Type="string" HeaderText="MIN THB/KG" Width="100"/>
                            <ej:Column Field="MAX_THB_KG"  Type="string" HeaderText="MAX THB/KG" Width="100"/>

                            <ej:Column Field="MIN_USD"  Type="string" HeaderText="MIN USD" Width="100"/>
                            <ej:Column Field="MID_USD"  Type="string" HeaderText="MID USD" Width="100"/>
                            <ej:Column Field="MAX_USD"  Type="string" HeaderText="MAX USD" Width="100"/>

                            <ej:Column Field="WL_MIN_USD"  Type="string" HeaderText="W/L MIN USD" Width="100"/>
                            <ej:Column Field="MD_MIN_USD"  Type="string" HeaderText="M/D MIN USD" Width="100"/>
                            <ej:Column Field="WL_MID_USD"  Type="string" HeaderText="W/L MID USD" Width="100"/>
                            <ej:Column Field="MD_MID_USD"  Type="string" HeaderText="M/D MID USD" Width="100"/>
                            <ej:Column Field="WL_MAX_USD"  Type="string" HeaderText="W/L MAX USD" Width="100"/>
                            <ej:Column Field="MD_MAX_USD"  Type="string" HeaderText="M/D MAX USD" Width="100"/>

                            <ej:Column Field="itcatdesc"  Type="string" HeaderText="Category"   Width="100"/>
                            <ej:Column Field="itsubcatdesc"  Type="string" HeaderText="Sub Category"   Width="100"/>
                            <ej:Column Field="itgroupdesc"  Type="string" HeaderText="Items Group"  Width="100" />
                            <ej:Column Field="itsubdesc"  Type="string" HeaderText="Sub Group"   Width="100"/>
                            <ej:Column Field="ittypedesc"  Type="string" HeaderText="Yarn Type"   Width="100"/>
                            <ej:Column Field="itsusbdesc2"  Type="string" HeaderText="Yarn Sub"    Width="100"/>
                       </Columns>             
                   </ej:grid>                    
                </div>
            </div>
