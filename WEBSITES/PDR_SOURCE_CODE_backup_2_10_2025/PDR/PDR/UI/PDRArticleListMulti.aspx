<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PDRArticleListMulti.aspx.cs" Inherits="PDR.UI.PDRArticleListMulti" %>
        ...
        <div class="row">
            <div class="col-xs-12" style="padding-left: 0px !important; padding-right: 0px !important; overflow: hidden !important; height: 100%;">
                ...
                <div class="panelnew panel-primary">
                        ...
                        <div class="col-xs-12">
                            ...
                            <table >
                                ...
                                <tr style="line-height: 5px !important;">
                                    ...
                                    <td colspan="10">
                                        <div class="pull-right" style="margin-right: 150px;">
                                            <asp:Button ID="btnFindTop" runat="server" Text="Find" CssClass="btn btn-success btnfont" OnClick="btnFind_Click" />&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;
                                        </div>
                                    </td>
                                ...
                                <tr style="line-height: 5px !important;">
                                    ...
                                    <td>
                                        <asp:Label ID="Label9" runat="server" Text="SHEET" CssClass="clsFromLabel"></asp:Label>
                                    </td>
                                    <td >
                                        <asp:DropDownList ID="ddlSheetName" runat="server" Style="width: 200px" CssClass="combo"></asp:DropDownList>
                                    </td>
                                    <td colspan="10">
                                        <div class="pull-right" style="margin-right: 150px;">
                                            <asp:Button ID="btnClearTop" runat="server" Text="Reset All" CssClass="btn btn-success btnfont" OnClick="btnClear_Click" />
                                            &nbsp;&nbsp;
                                        </div>
                                    </td>
                    ...
                    <div class="panel-body" style="width:1400px; overflow-y: scroll; overflow-x: scroll">
                        <div class="col-xs-12">
                            <Table>
                                ...
                                -->
                                <tr>
                                    <td class="borderall"><div style="height:350px; width:200px; overflow-y: scroll; overflow-x:hidden"> 
                                        <asp:CheckBoxList class="checkboxlist" ID="cblAppl" runat="server" DataTextField="lookup_value" DataValueField="lookup_value_id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
                                    <td class="borderall"><div style="height:350px; width:200px; overflow-y: scroll; overflow-x:hidden">
                                        <asp:CheckBoxList class="checkboxlist" ID="cblSubAppl" runat="server" DataTextField="lookup_value" DataValueField="lookup_value_id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
                                    <td class="borderall"><div style="height:350px; width:175px; overflow-y: scroll; overflow-x:hidden">
                                        <asp:CheckBoxList class="checkboxlist" ID="cblSplFunc" runat="server" DataTextField="lookup_value" DataValueField="lookup_value_id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
                                    <td class="borderall"><div style="height:350px; width:150px; overflow-y: scroll; overflow-x:hidden">
                                        <asp:CheckBoxList class="checkboxlist" ID="cblDesignType" runat="server" DataTextField="lookup_value" DataValueField="lookup_value_id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
                                    <td class="borderall"><div style="height:350px; width:175px; overflow-y: scroll; overflow-x:hidden">
                                        <asp:CheckBoxList class="checkboxlist" ID="cblFamilyName" runat="server" DataTextField="lookup_value" DataValueField="lookup_value_id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
                                    <td class="borderall"><div style="height:350px; width:500px; overflow-y: scroll; overflow-x:hidden">
                                        <asp:CheckBoxList class="checkboxlist" ID="cblFinishing" runat="server" DataTextField="fin_name" DataValueField="id" ></asp:CheckBoxList>
                                        </div>
                                    </td>
