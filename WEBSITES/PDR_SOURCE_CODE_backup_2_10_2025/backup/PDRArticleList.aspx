    ...
    <div class="container" style="top: 0px;">
        ...
        <div class="row">
            ...
            <div class="col-xs-12" style="padding-left: 0px !important; padding-right: 0px !important; overflow-x: visible !important; height: 100%;">
                   <ej:grid ID="grdArticleList" runat="server" AllowFiltering="true" AllowScrolling="true" AllowPaging="false">
                       ...
                       <Columns>
                            ...
                            <ej:Column Field="fabric_composition"  Type="string" HeaderText="Composition"  Width="100" />
                            <ej:Column Field="itptype" Type="string" HeaderText="Appl Func"  Width="100" />
                            <ej:Column Field="itpvalue" Type="string" HeaderText="Appl Func"  Width="100" />
