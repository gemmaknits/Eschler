...
Public Class formJobOrderforYarnCancel
	...
	Private Sub btnFindJob_no_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFindJob_no.Click
		...
		Try
            ...
            Dim da1 As New SqlDataAdapter(strsql3.ToString, connStr.Connection)
    ...
    Private Sub CancelJob()
        ...
        response = MsgBox("Are you sure to Cancel this job?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Delete Job")
        If response = MsgBoxResult.Yes Then
            cmdCancelJob.CommandType = CommandType.StoredProcedure
            cmdCancelJob.CommandText = "p_job_Cancel"
            cmdCancelJob.Parameters.AddWithValue("@jobno", Me.txtjobno.Text.Trim)
            cmdCancelJob.Parameters.AddWithValue("@rem_cancel", Me.textRemCancel.Text.Trim)
            cmdCancelJob.Parameters.AddWithValue("@log_empcd", loginEmpcd)
            ...
            Try
                ...
                tran.Commit()
                MsgBox("Job order Canceld succesfully")
            Catch ex As Exception
                tran.Rollback()
