...
Public Class formSearchItemcode
    ...
    Public Function getItemcode(ByVal p_itemNature As String) As String
        ...
        strSql.Append("select distinct itcd,itdesc2 from items ")
        If itemNature <> "ALL" Then
            strSql.Append(" where itnaturecd='")
            strSql.Append(itemNature & "'")
        End If
        strSql.Append("order by itdesc2")
        ...
        dvItems = New DataView(dtItems, "", "", DataViewRowState.CurrentRows)
        dgYarn.DataSource = dvItems
        dgYarn.Refresh()
        dgYarn.Visible = True
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim strSql As New StringBuilder
        strSql.Append("select distinct itcd,itdesc2 from items where itnaturecd='YARNS'")
        If itemNature <> "ALL" Then
            strSql.Append(" where itnaturecd='")
            strSql.Append(itemNature & "'")
        End If
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        If Me.TextBox1.Text.Trim <> "" Then
            dvItems.RowFilter = "itdesc2 LIKE '" & Me.TextBox1.Text.Trim & "*'"
        Else
            dvItems.RowFilter = ""
        End If
    End Sub
