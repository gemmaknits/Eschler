...
Public Class formYarnOutEdit
	...
	Private Sub LoadDataYarnInToYarnOut(ByVal SourceDoc As String)
        ...
        If IIf(SourceDoc = "YIN", textYarnInNo.Text.Trim.Length, txtJobNo.Text.Trim.Length) < 8 Then Exit Sub
        dt2 = getDatayarn.GetDataYarnOut(IIf(SourceDoc = "YIN", textYarnInNo.Text.Trim, txtJobNo.Text.Trim), SourceDoc)
    ...
    Private Sub EditData()
        ...
        '   Try
        tbl_Yarn_out.outno = Me.txtOutno.Text.Trim
        tbl_Yarn_out.outdt = IIf(IsDate(dtpoutdt.Text), CDate(dtpoutdt.Text), Today())
        ...
        tbl_Yarn_out.empcd = clsUser.UserID
        ...
        For i = 0 To count
            If Me.DgYarnOut.Rows(i).Cells("DgCheckbox").Value = True Then
        ...
        isvalid = UpdateYarn.UpdateYarnOut(tbl_Yarn_out, DgYarnOut.DataSource, msgerr, clsUser.UserID, RefDocnochanged)
    ...
    Private Sub btnPrintYarnout_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrintYarnout.Click
        ...
        Dim dt As DataTable = clsYarnOutBarCode.GetYOutByJob(strJobNo:="", strOutno:=txtOutno.Text.Trim, strlogempcd:=clsUser.UserID)
    ...
    Private Sub TextJobNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtJobNo.TextChanged
        'If TextJobNo.Text.Trim.Length < 8 Then Exit Sub
    ...
    Private Sub txtYOUT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtOutno.KeyPress
        If AscW(e.KeyChar) = 13 Then
            If txtOutno.Text.Trim.Length > 8 Then loadDataYarnOut()
        End If
    End Sub
    ...
    Private Sub loadDataYarnOut()
        ...
        dtt = Getdatayarnout.GetData_YarnOut(Me.txtOutno.Text.Trim, da, msgerr)
        dt.Dispose()
        dt = New DataTable
        dt = Getdatayarnout.GetData_YarnOutdet(Me.txtOutno.Text, da, msgerr)
        Me.DgYarnOut.DataSource = dt
        If dt.Rows.Count > 0 Then
            Me.txtJobNo.Text = dtt.Rows(0).Item("refdocno").ToString
            Me.oldRefDocno = dtt.Rows(0).Item("refdocno").ToString
            Me.dtpoutdt.Value = dtt.Rows(0).Item("outdt").ToString
            ...
            txtRemark.Text = dtt.Rows(0).Item("rem")
        End If
    End Sub
    ...
    Private Sub DgYarnOut_DefaultValuesNeeded(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowEventArgs) Handles DgYarnOut.DefaultValuesNeeded
        e.Row.Cells("outno").Value = Me.txtOutno.Text
    End Sub
    ...
    Private Sub btnSearchYout_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchYout.Click
        ...
        If selectedYarnOut <> "" Then
            Me.txtOutno.Text = selectedYarnOut
        End If
        loadDataYarnOut()
    End Sub
