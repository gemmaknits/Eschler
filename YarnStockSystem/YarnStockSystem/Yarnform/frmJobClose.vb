Public Class frmJobClose
    ...
    Private Sub GenComboPONo()
        ...
        cboPONo.ComboBox.DataSource = objDB.GetjobUnclose
    ...
    Private Sub LoadData(ByVal PONo As String)
        Dim objDB As New GetDataYarn
        Dim dt As New DataTable
        dt = objDB.GetJobUncloseDetail(PONo)
        Call BindGrid(dt)
    End Sub
    ...
    Private Function SaveData() As Boolean
        ...
        If clsYarn.CloseJob(dt, msgerr) Then
            SaveData = True
        Else
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If frm.pblnOk = True Then
            If Not blnCancel Then cboPONo.ComboBox.SelectedValue = frm.pJobNo
        End If
    ...
    Private Sub grdPurchaseOrder_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdPurchaseOrder.CellContentClick
