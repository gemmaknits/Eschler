...
Public Class InsertYarn
        ...
        Try
            For Each tbl_Yarn_in_det In ParamYarnin.tbl_Yarn_in_det
                ...
                With tbl_Yarn_in_det
                    ...
                    comm.Parameters.AddWithValue("@actual_cone_weight", .actual_cone_weight.ToString)
                    ...
                    comm.Parameters.AddWithValue("@box_remark", .box_remark)

                    comm.Parameters.AddWithValue("@mtl_warehouse_id", .mtl_warehouse_id)
                    comm.Parameters.AddWithValue("@mtl_subinventory_id", .mtl_subinventory_id)
                    comm.Parameters.AddWithValue("@mtl_locations_id", .mtl_locations_id)
                End With
    ...
    Public Function InsertYarnInReturn(ByRef ParamYarnin As tbl_Yarn_in, ByRef msgerr As String, ByVal loginempcd As String) As Boolean
        Dim conn As New SqlConnection(connStr.Connection())
        conn.Open()
        ...
        comm.Transaction = tran
        comm.CommandType = CommandType.StoredProcedure
        If ParamYarnin.tran_type = "JOB RETURN" Or ParamYarnin.tran_type = "WARPING" Then
            comm.CommandText = "p_yarn_in_return_job_insert"
        Else
            comm.CommandText = "p_yarn_in_return_insert"
        End If
        With ParamYarnin
            comm.Parameters.Clear()
            comm.Parameters.AddWithValue("@docno", .docno) '1
            comm.Parameters.AddWithValue("@docdt", .docdt) '1
            comm.Parameters.AddWithValue("@tran_type", .tran_type.Trim)
            comm.Parameters.AddWithValue("@outno", .outno.Trim)
            comm.Parameters.AddWithValue("@remark", .remark.Trim)
            comm.Parameters.AddWithValue("@sinvno", .sinvno.Trim) 'Add By Neung 21/07/2015 ( Eschler Need Them)
            comm.Parameters.AddWithValue("@sinvdt", .sinvdt) 'Add By Neung 21/07/2015 ( Eschler Need Them)
        ...
        ParamYarnin.docno = dt.Rows(0)("docno").ToString.Trim
        Dim i As Integer = 0
        Dim tbl_Yarn_in_det As New tbl_Yarn_in_det
        'pDocno = docno
        ...
        Try
            For Each tbl_Yarn_in_det In ParamYarnin.tbl_Yarn_in_det
                comm.CommandType = CommandType.StoredProcedure
                comm.Transaction = tran
                If ParamYarnin.tran_type = "JOB RETURN" Then
                    comm.CommandText = "p_yarn_in_return_job_det_insert"
                ElseIf ParamYarnin.tran_type = "RETURN" Then
                    comm.CommandText = "p_yarn_in_return_det_insert"
                End If
                comm.Parameters.Clear()

                With tbl_Yarn_in_det
                    comm.Parameters.AddWithValue("@docno", ParamYarnin.docno.Trim)
                    comm.Parameters.AddWithValue("@itcd", .itcd.Trim)
                    ...
                    comm.Parameters.AddWithValue("@mtl_subinventory_id", .mtl_subinventory_id)
                    comm.Parameters.AddWithValue("@mtl_locations_id", .mtl_locations_id)
                    comm.Parameters.AddWithValue("@mfg_production_order_line_id", (New clsConfig).IsNull(.mfg_production_order_line_id, DBNull.Value))
                    comm.Parameters.AddWithValue("@id_yarn_out_det", (New clsConfig).IsNull(.id_yarn_out_det, DBNull.Value))

                    If ParamYarnin.tran_type = "JOB RETURN" Then
                        comm.Parameters.AddWithValue("@lotno_sup", ParamYarnin.lotno_sup)
                        comm.Parameters.AddWithValue("@lotno_our", ParamYarnin.lotno_our)
                        comm.Parameters.AddWithValue("@boxno_s", .boxno_s.Trim)
                        comm.Parameters.AddWithValue("@boxno_f", .boxno_o.Trim)
                        comm.Parameters.AddWithValue("@box_count", 0)
                        comm.Parameters.AddWithValue("@boxno2", "")
                        comm.Parameters.AddWithValue("@suppcd", ParamYarnin.suppcd)
                    End If
                End With
                da = New SqlDataAdapter(comm)
                dt = New DataTable
        ...
        comm.Parameters.AddWithValue("@docno", ParamYarnin.docno)
    ...
    Public Function InsertYarnOut(ByRef paramtbl_yarn_out As tbl_Yarn_out, ByRef msgerr As String, ByVal loginEmpcd As String) As Boolean
        Dim conn As New SqlConnection(connStr.Connection())
        conn.Open()
        ...
        paramtbl_yarn_out.outno = dt.Rows(0)("outno").ToString.Trim
        paramtbl_yarn_out.packno = dt.Rows(0)("packno").ToString.Trim

        Dim i As Integer = 0
        Dim tbl_Yarn_out_det As New tbl_Yarn_out_det
        tbl_Yarn_out_det.outno = dt.Rows(0)("outno").ToString.Trim
        'Youtno = docno
        ...
        Try
            For Each tbl_Yarn_out_det In paramtbl_yarn_out.tbl_Yarn_out_det
                ...
                With tbl_Yarn_out_det
                    comm.Parameters.AddWithValue("@outno", paramtbl_yarn_out.outno.Trim)
                    comm.Parameters.AddWithValue("@itcd", .itcd.Trim)
                    comm.Parameters.AddWithValue("@grade", .grade.Trim)
                    comm.Parameters.AddWithValue("@boxno", .boxno.Trim)
                    comm.Parameters.AddWithValue("@id_job_det_yarn", .id_job_det_yarn.ToString)
                    comm.Parameters.AddWithValue("@gb", .gb)
                    comm.Parameters.AddWithValue("@mfg_production_order_line_id", .mfg_production_order_line_id)
                End With
    ...
    Public Function InsertJobOrderforYarnNew(ByRef tbl_job As tbl_job, ByRef msgerr As String, ByVal loginEmpcd As String) As Boolean
        Dim conn As New SqlConnection(connStr.Connection())
        conn.Open()
        ...
        comm.Transaction = tran
        comm.CommandType = CommandType.StoredProcedure
        comm.CommandText = "P_JOBORDER_YARN_PKG_insert_job"
        With tbl_job
            comm.Parameters.AddWithValue("@jobno", .jobno.Trim)
        ...
        '================================ Insert to Job Det and Job Det Yarn (Group By Items) ===================================
        tbl_job.jobno = dt.Rows(0)("jobno").ToString.Trim
        Dim i As Integer = 0
        Dim j As Integer = 0
        ...
        For Each tbl_job_det In tbl_job.tbl_job_det
            ...
            comm.CommandType = CommandType.StoredProcedure
            comm.Transaction = tran
            comm.CommandText = "P_JOBORDER_YARN_PKG_insert_job_det"
            With tbl_job_det
                comm.Parameters.AddWithValue("@jobno", tbl_job.jobno)
                comm.Parameters.AddWithValue("@itcd", .itcd.Trim)
        ...
        For Each tbl_job_det_yarn In tbl_job.tbl_job_det_yarn
            For Each tbl_job_det In tbl_job.tbl_job_det
                If tbl_job_det.itcd.Trim = tbl_job_det_yarn.itcd.Trim Then
                    If (New clsConfig).IsNull(tbl_job_det.mfg_production_order_line_id, 0) = (New clsConfig).IsNull(tbl_job_det_yarn.mfg_production_order_line_id, 0) Then
                        comm = New SqlCommand("", conn)
                        comm.CommandType = CommandType.StoredProcedure
                        comm.Transaction = tran
                        comm.CommandText = "P_JOBORDER_YARN_PKG_insert_job_det_yarn"
                        With tbl_job_det_yarn
                            comm.Parameters.AddWithValue("@id_job_det", tbl_job_det.id_jobdet.ToString)
                            ' comm.Parameters.AddWithValue("@id_job_det", tbl_job.tbl_job_det(i).id_jobdet.ToString)
                            comm.Parameters.AddWithValue("@itcd", .itcd.Trim)
                            comm.Parameters.AddWithValue("@boxno", .boxno.Trim)
                            comm.Parameters.AddWithValue("@spools", .spools.ToString)
                            comm.Parameters.AddWithValue("@kg_gr", .kg_gr)
                            comm.Parameters.AddWithValue("@kg_nt", .kg_nt)
                            comm.Parameters.AddWithValue("@actual_cone_weight", oConfig.IsNull(.actual_cone_weight, 0))
                            comm.Parameters.AddWithValue("@lotno_our", .lotno_our.ToString)
                            comm.Parameters.AddWithValue("@gb", .gb)
        ...
        comm.Parameters.Clear()
        comm.Parameters.AddWithValue("@empcd", loginEmpcd)
        comm.Parameters.AddWithValue("@docno", tbl_job.jobno)
        comm.Parameters.AddWithValue("@action", "NEW")
        Try
            da.Fill(dt)
        Catch ex As Exception
        ...
        '=================================== Add By Neung 20191223 Auto App ==========
        comm.CommandText = "P_JOBORDER_YARN_PKG_update_job_approve"
        comm.CommandType = CommandType.StoredProcedure
        comm.Parameters.Clear()
        comm.Parameters.AddWithValue("@log_empcd", loginEmpcd)
        comm.Parameters.AddWithValue("@jobno", tbl_job.jobno)
        comm.Parameters.AddWithValue("@rem_app", "Auto Approve By Program")
        Try
            da.Fill(dt)
        Catch ex As Exception
            msgerr = ex.Message
